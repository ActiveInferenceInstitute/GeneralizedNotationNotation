...
data Q = Q Double
data R = R Double
data control_gain = control_gain Double
data goal_mean = goal_mean Double
...
uTox :: u -> x
uTox x = undefined
goal_meanTou :: goal_mean -> u
goal_meanTou x = undefined
control_gainTou :: control_gain -> u
control_gainTou x = undefined
