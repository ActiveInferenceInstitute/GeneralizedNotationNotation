...
![The v3.0.0 long-running orchestration contracts: durable observation streams, resumable run sessions, and auditable container plans.](../output/figures/gnn_orchestration.png){#fig:orchestration width=85%}
