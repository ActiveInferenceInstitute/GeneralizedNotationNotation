...
# INFO: Processing variable: s with dimensions [3, 1] and type hidden_state
# INFO: Recognized s variable: 3 states
# INFO: Processing variable: s_prime with dimensions [3, 1] and type hidden_state
# INFO: Unrecognized variable: s_prime with dimensions [3, 1]
# INFO: Processing variable: o with dimensions [3, 1] and type observation
# INFO: Recognized o variable: 3 outcomes
# INFO: Processing variable: π with dimensions [3] and type policy
# INFO: Unrecognized variable: π with dimensions [3]
# INFO: Processing variable: u with dimensions [1] and type action
# INFO: Unrecognized variable: u with dimensions [1]
# INFO: Processing variable: G with dimensions [1] and type policy
# INFO: Unrecognized variable: G with dimensions [1]
# INFO: Processing variable: t with dimensions [1] and type hidden_state
...
# INFO: DEBUG: _extract_initial_parameterization_matrices: initial_params = {'node_type': 'Parameter', 'source_location': None, 'metadata': {}, 'id': 'abad646b-1884-43d3-9411-58b10e0b9b48', 'name': 'num_actions: 3       # B actions_dim', 'value': '3 (controlled by π)', 'type_hint': None, 'description': None}
