...
# --- GNN Model: The_Generative_Poetic_Muse_v10 ---
...
# --- Agent Instantiation ---
The_Generative_Poetic_Muse_v10 = Agent(
    A=A,
    B=B,
    C=C
)
...
if __name__ == '__main__':
    ...
    agent = The_Generative_Poetic_Muse_v10
    print(f"Agent 'The_Generative_Poetic_Muse_v10' initialized with {agent.num_factors if hasattr(agent, 'num_factors') else 'N/A'} factors and {agent.num_modalities if hasattr(agent, 'num_modalities') else 'N/A'} modalities.")
