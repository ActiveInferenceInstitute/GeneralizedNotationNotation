...
# --- GNN Model: Active_Inference_Language_Model_AILM_v01 ---
...
# --- Agent Instantiation ---
Active_Inference_Language_Model_AILM_v01 = Agent(
    A=A,
    B=B,
    C=C
)
...
if __name__ == '__main__':
    ...
    agent = Active_Inference_Language_Model_AILM_v01
    print(f"Agent 'Active_Inference_Language_Model_AILM_v01' initialized with {agent.num_factors if hasattr(agent, 'num_factors') else 'N/A'} factors and {agent.num_modalities if hasattr(agent, 'num_modalities') else 'N/A'} modalities.")
