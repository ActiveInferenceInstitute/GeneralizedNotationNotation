#!/usr/bin/env python3
"""
PyMDP Agent Script - RxInfer_Hidden_Markov_Model_v1
...
# INFO: Found StateSpaceBlock data with 17 items.
# INFO: Parsed ModelParameters from raw text: {'n_states=3              # Hidden states': 'Bedroom, Living room, Bathroom', 'n_obs=3                 # Observation categories': '3 discrete outcomes'}
