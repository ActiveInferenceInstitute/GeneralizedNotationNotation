...
\begin{frame}[allowframebreaks]{Current Limitations}
...
every registered backend today, and authors should consult the recorded
backend matrix before assuming a given family will round-trip through a
given framework.
...
3.2.0 contracts are evidenced by theirs today.
\end{frame}
