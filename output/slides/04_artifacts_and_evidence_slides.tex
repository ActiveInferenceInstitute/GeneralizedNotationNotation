...
fan out across the executable-model leg of the Triple Play (Smékal and
Friedman 2023). The families and their declared frameworks are
enumerated below.
...
\begin{figure}
\centering
\includegraphics[width=0.8\linewidth,height=0.40\textheight,keepaspectratio,alt={Repository-scale metrics --- source packages, test files, and tool surface --- measured from the tracked files at the commit the producer stamps.}]{../figures/gnn_repo_metrics.png}
