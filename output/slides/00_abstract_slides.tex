...
discrete categorical kind of eq.~1 through
eq.~8 and its own matrix vocabulary for the other model
...
2023). A GNN file denotes a generative model, and the language lets that
model take the several shapes the field actually uses: the notation
\end{frame}

\begin{frame}[fragile,allowframebreaks]{Abstract}
blocks a file declares --- categorical
