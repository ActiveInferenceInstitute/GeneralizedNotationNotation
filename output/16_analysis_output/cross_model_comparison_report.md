...
**Generated:** 2026-04-14 11:11:02

**Models:** 9 | **Frameworks:** 7

## Summary Matrix

| Model | PyMDP | JAX | RxInfer | ActiveInf.jl | DisCoPy | PyTorch | NumPyro |
|---|---|---|---|---|---|---|---|
| **actinf_pomdp_agent** | ✅ 0.951 | ✅ 0.993 | ✅ 0.993 | ✅ 0.945 | — | ✅ 1.000 | ✅ 1.000 |
| **bnlearn_causal_model** | ✅ 0.903 | ✅ 0.909 | ✅ 0.909 | ✅ 0.782 | — | ✅ 1.000 | ✅ 1.000 |
| **deep_planning_horizon** | ✅ 0.891 | ✅ 0.934 | ✅ 0.922 | ✅ 0.566 | — | ✅ 1.000 | ✅ 1.000 |
| **hmm_baseline** | ✅ 0.605 | ✅ 0.808 | ✅ 0.654 | — | — | ✅ 1.000 | ✅ 1.000 |
| **markov_chain** | ✅ 1.000 | ✅ 1.000 | ✅ 1.000 | — | — | ✅ 1.000 | ✅ 1.000 |
| **multi_armed_bandit** | ✅ 0.628 | ✅ 0.511 | ✅ 0.578 | ✅ 0.432 | — | ✅ 1.000 | ✅ 1.000 |
| **simple_mdp** | ✅ 1.000 | ✅ 1.000 | ✅ 1.000 | ✅ 1.000 | — | ✅ 1.000 | ✅ 1.000 |
| **tmaze_epistemic** | ✅ 1.000 | ✅ 1.000 | ✅ 0.999 | — | — | ✅ 1.000 | ✅ 1.000 |
| **two_state_bistable** | ✅ 0.806 | ✅ 0.796 | ✅ 0.810 | ✅ 0.669 | — | ✅ 1.000 | ✅ 1.000 |
...
| Model | PyMDP | JAX | RxInfer | ActiveInf.jl | DisCoPy | PyTorch | NumPyro |
|---|---|---|---|---|---|---|---|
| **actinf_pomdp_agent** | 0.8490 | -0.1412 | 0.7186 | -1.1827 | — | 1.4951 | 0.5951 |
| **bnlearn_causal_model** | 0.9627 | 0.0324 | 0.4095 | -0.5528 | — | 1.3133 | 0.3133 |
| **deep_planning_horizon** | 0.5530 | 0.8795 | 1.9524 | -1.4137 | — | 2.6939 | 2.6939 |
| **hmm_baseline** | 0.3266 | 1.6440 | 1.4691 | — | — | 1.7918 | 1.7918 |
| **markov_chain** | 0.9360 | 0.0693 | 0.1309 | — | — | 1.0986 | 1.0986 |
| **multi_armed_bandit** | 1.5207 | 0.1612 | 2.2111 | -2.0129 | — | 3.1698 | 0.1698 |
| **simple_mdp** | 3.0251 | -2.2688 | 0.1141 | -2.5737 | — | 3.1392 | 3.1392 |
| **tmaze_epistemic** | 0.9704 | 0.0000 | 1.1307 | — | — | 1.3863 | 1.3863 |
| **two_state_bistable** | 1.3643 | -0.4299 | 0.8909 | -1.1092 | — | 0.1269 | 0.1269 |
...
| Model | PyMDP | JAX | RxInfer | ActiveInf.jl | DisCoPy | PyTorch | NumPyro |
|---|---|---|---|---|---|---|---|
| **actinf_pomdp_agent** | 0.1129 | 0.0293 | 0.0293 | 0.1622 | — | 0.0000 | 0.0000 |
| **bnlearn_causal_model** | 0.3005 | 0.2874 | 0.2874 | 0.5088 | — | 0.0000 | 0.0000 |
| **deep_planning_horizon** | 0.3917 | 0.2016 | 0.2909 | 1.1075 | — | 0.0000 | 0.0000 |
| **hmm_baseline** | 1.0109 | 0.5118 | 0.9518 | — | — | 0.0000 | 0.0000 |
| **markov_chain** | 0.0000 | 0.0000 | 0.0000 | — | — | 0.0000 | 0.0000 |
| **multi_armed_bandit** | 0.8140 | 0.7833 | 0.8007 | 1.0132 | — | 0.0000 | 0.0000 |
| **simple_mdp** | 0.0000 | 0.0000 | 0.0000 | 0.0013 | — | 0.0000 | 0.0000 |
| **tmaze_epistemic** | 0.0000 | 0.0000 | 0.0047 | — | — | 0.0000 | 0.0000 |
| **two_state_bistable** | 0.4546 | 0.4939 | 0.4650 | 0.6320 | — | 0.0000 | 0.0000 |
...
|-----------|-------|------------|------------|---------|------------------|------------|
| PyMDP | 15 | 0.9512 | 0.8490 | 0.1129 | 0.200 | ✅ |
...
| Framework | Steps | Confidence | EFE (mean) | Entropy | Action Diversity | Validation |
|-----------|-------|------------|------------|---------|------------------|------------|
| PyMDP | 15 | 0.9032 | 0.9627 | 0.3005 | 0.133 | ✅ |
| JAX | 15 | 0.9091 | 0.0324 | 0.2874 | 0.133 | ✅ |
| RxInfer | 15 | 0.9091 | 0.4095 | 0.2874 | 0.133 | ✅ |
| ActiveInf.jl | 15 | 0.7815 | -0.5528 | 0.5088 | 0.133 | ✅ |
| DisCoPy | — | — | — | — | — | — |
| PyTorch | 15 | 1.0000 | 1.3133 | 0.0000 | 0.133 | ✅ |
| NumPyro | 15 | 1.0000 | 0.3133 | 0.0000 | 0.133 | ✅ |

**Highest confidence:** NumPyro (1.0000) | **Lowest:** ActiveInf.jl (0.7815)

### deep_planning_horizon

| Framework | Steps | Confidence | EFE (mean) | Entropy | Action Diversity | Validation |
|-----------|-------|------------|------------|---------|------------------|------------|
| PyMDP | 15 | 0.8912 | 0.5530 | 0.3917 | 0.133 | ✅ |
...
| Framework | Steps | Confidence | EFE (mean) | Entropy | Action Diversity | Validation |
|-----------|-------|------------|------------|---------|------------------|------------|
| PyMDP | 15 | 0.6054 | 0.3266 | 1.0109 | 0.067 | ✅ |
...
**Highest confidence:** NumPyro (1.0000) | **Lowest:** PyMDP (0.6054)

### markov_chain

| Framework | Steps | Confidence | EFE (mean) | Entropy | Action Diversity | Validation |
|-----------|-------|------------|------------|---------|------------------|------------|
| PyMDP | 15 | 1.0000 | 0.9360 | 0.0000 | 0.067 | ✅ |
...
| Framework | Steps | Confidence | EFE (mean) | Entropy | Action Diversity | Validation |
|-----------|-------|------------|------------|---------|------------------|------------|
| PyMDP | 15 | 1.0000 | 3.0251 | 0.0000 | 0.133 | ✅ |
...
| Framework | Steps | Confidence | EFE (mean) | Entropy | Action Diversity | Validation |
|-----------|-------|------------|------------|---------|------------------|------------|
| PyMDP | 15 | 1.0000 | 0.9704 | 0.0000 | 0.133 | ✅ |
...
| Framework | Steps | Confidence | EFE (mean) | Entropy | Action Diversity | Validation |
|-----------|-------|------------|------------|---------|------------------|------------|
| PyMDP | 15 | 0.8055 | 1.3643 | 0.4546 | 0.133 | ✅ |
...
- **Lowest avg. confidence:** multi_armed_bandit (0.6914)

---

*Generated by GNN Analysis Pipeline — 2026-04-14 11:11:02*
