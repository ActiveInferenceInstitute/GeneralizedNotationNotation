...
| **deep_planning_horizon** | ✅ 0.905 | ✅ 0.934 | ✅ 0.922 | ✅ 0.566 | — | ✅ 1.000 | ✅ 1.000 |
| **hmm_baseline** | ✅ 0.644 | ✅ 0.808 | ✅ 0.654 | — | — | ✅ 1.000 | ✅ 1.000 |
| **markov_chain** | ✅ 1.000 | ✅ 1.000 | ✅ 1.000 | — | — | ✅ 1.000 | ✅ 1.000 |
| **multi_armed_bandit** | ✅ 0.502 | ✅ 0.511 | ✅ 0.578 | ✅ 0.432 | — | ✅ 1.000 | ✅ 1.000 |
| **simple_mdp** | ✅ 1.000 | ✅ 1.000 | ✅ 1.000 | ✅ 1.000 | — | ✅ 1.000 | ✅ 1.000 |
| **tmaze_epistemic** | ✅ 1.000 | ✅ 1.000 | ✅ 0.999 | — | — | ✅ 1.000 | ✅ 1.000 |
| **two_state_bistable** | ✅ 0.789 | ✅ 0.796 | ✅ 0.810 | ✅ 0.669 | — | ✅ 1.000 | ✅ 1.000 |
...
| Model | PyMDP | JAX | RxInfer | ActiveInf.jl | DisCoPy | PyTorch | NumPyro |
|---|---|---|---|---|---|---|---|
| **actinf_pomdp_agent** | -0.6698 | -0.1412 | 0.7186 | -1.1827 | — | 1.4951 | 0.5951 |
| **deep_planning_horizon** | -1.5952 | 0.8795 | 1.9524 | -1.4137 | — | 3.1939 | 2.6939 |
| **hmm_baseline** | -1.4801 | 1.6440 | 1.4691 | — | — | 1.7918 | 1.7918 |
| **markov_chain** | -0.2074 | 0.0693 | 0.1309 | — | — | 1.0986 | 1.0986 |
| **multi_armed_bandit** | -2.1114 | 0.1612 | 2.2111 | -2.0129 | — | 2.1698 | 0.1698 |
| **simple_mdp** | -0.1141 | -2.2688 | 0.1141 | -2.5737 | — | 0.1392 | 3.1392 |
| **tmaze_epistemic** | -0.1848 | 0.0000 | 1.1307 | — | — | 1.3863 | 1.3863 |
| **two_state_bistable** | -0.7770 | -0.4299 | 0.8909 | -1.1092 | — | 0.1269 | 0.1269 |
...
| **deep_planning_horizon** | 0.3310 | 0.2016 | 0.2909 | 1.1075 | — | 0.0000 | 0.0000 |
| **hmm_baseline** | 0.8965 | 0.5118 | 0.9518 | — | — | 0.0000 | 0.0000 |
| **markov_chain** | 0.0000 | 0.0000 | 0.0000 | — | — | 0.0000 | 0.0000 |
| **multi_armed_bandit** | 0.8932 | 0.7833 | 0.8007 | 1.0132 | — | 0.0000 | 0.0000 |
| **simple_mdp** | 0.0000 | 0.0000 | 0.0000 | 0.0013 | — | 0.0000 | 0.0000 |
| **tmaze_epistemic** | 0.0000 | 0.0000 | 0.0047 | — | — | 0.0000 | 0.0000 |
| **two_state_bistable** | 0.4822 | 0.4939 | 0.4650 | 0.6320 | — | 0.0000 | 0.0000 |
...
|-----------|-------|------------|------------|---------|------------------|------------|
| PyMDP | 15 | 0.9890 | -0.6698 | 0.0457 | 0.133 | ✅ |
...
| Framework | Steps | Confidence | EFE (mean) | Entropy | Action Diversity | Validation |
|-----------|-------|------------|------------|---------|------------------|------------|
| PyMDP | 15 | 0.9054 | -1.5952 | 0.3310 | 0.133 | ✅ |
...
| Framework | Steps | Confidence | EFE (mean) | Entropy | Action Diversity | Validation |
|-----------|-------|------------|------------|---------|------------------|------------|
| PyMDP | 15 | 0.6440 | -1.4801 | 0.8965 | 0.067 | ✅ |
...
**Highest confidence:** NumPyro (1.0000) | **Lowest:** PyMDP (0.6440)

### markov_chain

| Framework | Steps | Confidence | EFE (mean) | Entropy | Action Diversity | Validation |
|-----------|-------|------------|------------|---------|------------------|------------|
| PyMDP | 15 | 1.0000 | -0.2074 | 0.0000 | 0.067 | ✅ |
...
| Framework | Steps | Confidence | EFE (mean) | Entropy | Action Diversity | Validation |
|-----------|-------|------------|------------|---------|------------------|------------|
| PyMDP | 15 | 0.5020 | -2.1114 | 0.8932 | 0.067 | ✅ |
...
| Framework | Steps | Confidence | EFE (mean) | Entropy | Action Diversity | Validation |
|-----------|-------|------------|------------|---------|------------------|------------|
| PyMDP | 15 | 0.7890 | -0.7770 | 0.4822 | 0.133 | ✅ |
...
- **Lowest avg. confidence:** multi_armed_bandit (0.6704)

---

*Generated by GNN Analysis Pipeline — 2026-03-13 11:38:19*
