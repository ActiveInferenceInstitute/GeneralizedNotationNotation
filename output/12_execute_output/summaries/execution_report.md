...
**Generated:** 2026-05-12T07:29:01.510947
**Target Directory:** input/gnn_files/discrete
**Output Directory:** output/12_execute_output

## Summary

- **Total Scripts Found:** 80
- **Successful Executions:** 70
- **Failed Executions:** 0
- **Skipped (dependency not installed):** 10

## Execution Details

### Simple Markov Chain_numpyro.py - ⏭️ SKIPPED
...
- **Reason:** Dependency not installed: numpyro
...
### Deep Planning Horizon POMDP_numpyro.py - ⏭️ SKIPPED
...
### Hidden Markov Model Baseline_numpyro.py - ⏭️ SKIPPED
...
### Active Inference POMDP Agent_numpyro.py - ⏭️ SKIPPED
...
### Active Inference POMDP Agent_bnlearn.py - ✅ SUCCESS
...
### Time-Varying Transition Dynamics Agent_numpyro.py - ⏭️ SKIPPED

- **Framework:** numpyro
- **Executor:** /Users/mini/Documents/GitHub/GeneralizedNotationNotation/.venv/bin/python
- **Path:** `output/11_render_output/time_varying_dynamics/numpyro/Time-Varying Transition Dynamics Agent_numpyro.py`
- **Reason:** Dependency not installed: numpyro

### Time-Varying Transition Dynamics Agent_pymdp.py - ✅ SUCCESS

- **Framework:** pymdp
- **Executor:** /Users/mini/Documents/GitHub/GeneralizedNotationNotation/.venv/bin/python
- **Path:** `output/11_render_output/time_varying_dynamics/pymdp/Time-Varying Transition Dynamics Agent_pymdp.py`
- **Return Code:** 0
- **Execution Time:** 2.53 seconds
- **Detailed Output:** output/12_execute_output/time_varying_dynamics/pymdp/execution_logs/Time-Varying Transition Dynamics Agent_pymdp.py_execution.log

### Time-Varying Transition Dynamics Agent_pytorch.py - ✅ SUCCESS

- **Framework:** pytorch
- **Executor:** /Users/mini/Documents/GitHub/GeneralizedNotationNotation/.venv/bin/python
- **Path:** `output/11_render_output/time_varying_dynamics/pytorch/Time-Varying Transition Dynamics Agent_pytorch.py`
- **Return Code:** 0
- **Execution Time:** 0.50 seconds
- **Detailed Output:** output/12_execute_output/time_varying_dynamics/pytorch/execution_logs/Time-Varying Transition Dynamics Agent_pytorch.py_execution.log

### Time-Varying Transition Dynamics Agent_jax.py - ✅ SUCCESS

- **Framework:** jax
- **Executor:** /Users/mini/Documents/GitHub/GeneralizedNotationNotation/.venv/bin/python
- **Path:** `output/11_render_output/time_varying_dynamics/jax/Time-Varying Transition Dynamics Agent_jax.py`
- **Return Code:** 0
- **Execution Time:** 0.72 seconds
- **Detailed Output:** output/12_execute_output/time_varying_dynamics/jax/execution_logs/Time-Varying Transition Dynamics Agent_jax.py_execution.log

### Time-Varying Transition Dynamics Agent_discopy.py - ✅ SUCCESS

- **Framework:** discopy
- **Executor:** /Users/mini/Documents/GitHub/GeneralizedNotationNotation/.venv/bin/python
- **Path:** `output/11_render_output/time_varying_dynamics/discopy/Time-Varying Transition Dynamics Agent_discopy.py`
- **Return Code:** 0
- **Execution Time:** 0.24 seconds
- **Detailed Output:** output/12_execute_output/time_varying_dynamics/discopy/execution_logs/Time-Varying Transition Dynamics Agent_discopy.py_execution.log

### Time-Varying Transition Dynamics Agent_bnlearn.py - ✅ SUCCESS

- **Framework:** bnlearn
- **Executor:** /Users/mini/Documents/GitHub/GeneralizedNotationNotation/.venv/bin/python
- **Path:** `output/11_render_output/time_varying_dynamics/bnlearn/Time-Varying Transition Dynamics Agent_bnlearn.py`
- **Return Code:** 0
- **Execution Time:** 1.93 seconds
- **Detailed Output:** output/12_execute_output/time_varying_dynamics/bnlearn/execution_logs/Time-Varying Transition Dynamics Agent_bnlearn.py_execution.log

### Multi Armed Bandit Agent_numpyro.py - ⏭️ SKIPPED
...
### Multi Armed Bandit Agent_bnlearn.py - ✅ SUCCESS
...
### T-Maze Epistemic Foraging Agent_numpyro.py - ⏭️ SKIPPED
...
### T-Maze Epistemic Foraging Agent_bnlearn.py - ✅ SUCCESS
...
### Bnlearn Causal Model_numpyro.py - ⏭️ SKIPPED
...
- **Framework:** discopy
- **Executor:** /Users/mini/Documents/GitHub/GeneralizedNotationNotation/.venv/bin/python
- **Path:** `output/11_render_output/bnlearn_causal_model/discopy/Bnlearn Causal Model_discopy.py`
- **Return Code:** 0
- **Execution Time:** 0.24 seconds
- **Detailed Output:** output/12_execute_output/bnlearn_causal_model/discopy/execution_logs/Bnlearn Causal Model_discopy.py_execution.log

### Bnlearn Causal Model_bnlearn.py - ✅ SUCCESS
...
### Two State Bistable POMDP_numpyro.py - ⏭️ SKIPPED
...
### Simple MDP Agent_numpyro.py - ⏭️ SKIPPED
...
### Time-Varying Transition Dynamics Agent_rxinfer.jl - ✅ SUCCESS

- **Framework:** rxinfer
- **Executor:** julia
- **Path:** `output/11_render_output/time_varying_dynamics/rxinfer/Time-Varying Transition Dynamics Agent_rxinfer.jl`
- **Return Code:** 0
- **Execution Time:** 13.29 seconds
- **Detailed Output:** output/12_execute_output/time_varying_dynamics/rxinfer/execution_logs/Time-Varying Transition Dynamics Agent_rxinfer.jl_execution.log

### Time-Varying Transition Dynamics Agent_activeinference.jl - ✅ SUCCESS

- **Framework:** activeinference_jl
- **Executor:** julia
- **Path:** `output/11_render_output/time_varying_dynamics/activeinference_jl/Time-Varying Transition Dynamics Agent_activeinference.jl`
- **Return Code:** 0
- **Execution Time:** 13.68 seconds
- **Detailed Output:** output/12_execute_output/time_varying_dynamics/activeinference_jl/execution_logs/Time-Varying Transition Dynamics Agent_activeinference.jl_execution.log
