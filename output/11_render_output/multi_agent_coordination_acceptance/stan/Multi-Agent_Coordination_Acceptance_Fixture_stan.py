#!/usr/bin/env python3
"""
Stan POMDP/HMM driver: Multi-Agent Coordination Acceptance Fixture
...
STAN_FILE = Path(__file__).resolve().with_name('Multi-Agent_Coordination_Acceptance_Fixture_stan.stan')
RANDOM_SEED = 42
T = 20
S, O, U = 2, 2, 2
PSEUDO_COUNT_STRENGTH = 20.0
NUTS_PARAM_BUDGET = 1024
A = np.asarray([[0.9, 0.1], [0.1, 0.9]], dtype=float)          # O x S, columns sum to 1
B = np.asarray([[[0.9, 0.1], [0.1, 0.9]], [[0.1, 0.9], [0.9, 0.1]]], dtype=float)          # S(next) x S(prev) x U
