#!/usr/bin/env python3
"""
Stan POMDP/HMM driver: Dynamic Perception Model
...
STAN_FILE = Path(__file__).resolve().with_name('Dynamic_Perception_Model_stan.stan')
RANDOM_SEED = 42
T = 10
S, O, U = 2, 2, 1
...
B = np.asarray([[[0.7], [0.3]], [[0.3], [0.7]]], dtype=float)          # S(next) x S(prev) x U
