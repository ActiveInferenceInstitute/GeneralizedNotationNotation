...
def run_simulation():
    ...
    A = torch.tensor([
        [0.900000, 0.050000, 0.025000, 0.025000],
        [0.050000, 0.900000, 0.025000, 0.025000],
        [0.025000, 0.025000, 0.900000, 0.050000],
        [0.025000, 0.025000, 0.050000, 0.900000]
    ], dtype=torch.float64)
    C = torch.tensor([-1.000000, -0.500000, -0.500000, 2.000000], dtype=torch.float64)
