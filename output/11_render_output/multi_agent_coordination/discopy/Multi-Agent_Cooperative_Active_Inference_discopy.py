...
def export_circuit_data(circuit_dict, analysis_results, output_dir="discopy_diagrams"):
    ...
    circuit_info = {
        'model_name': 'Multi-Agent Cooperative Active Inference',
        'timestamp': '2026-09-08 06:58:05',
        'parameters': {
...
def main():
    ...
    print(f"Model: Multi-Agent Cooperative Active Inference")
    print("="*60)
