"""
JAX Model Generated from GNN Specification: Static_Perception_Model
...
def create_params() -> Dict[str, jnp.ndarray]:
    ...
    return {
        'A_matrix': jnp.array([[0.8181818181818181, 0.11111111111111112], [0.18181818181818182, 0.888888888888889]]),  # Observation model P(o|s)
        'B_matrix': jnp.array([[[0.95, 0.05], [0.05, 0.95]], [[0.05, 0.95], [0.95, 0.05]]]),  # Transition model P(s'|s,a)
        'C_vector': jnp.array([0.0, 0.0]),  # Preferences over observations
...
def get_model_summary() -> str:
    ...
    return f"""
Static_Perception_Model Model Summary (Pure JAX Implementation):
...
if __name__ == "__main__":
    ...
    print("=" * 60)
    print("JAX Active Inference Model: Static_Perception_Model")
    print("=" * 60)
    ...
    trajectory = run_simulation(params, num_steps=5)
    ...
    results_file = save_simulation_results(trajectory, params, "Static_Perception_Model", output_dir)
