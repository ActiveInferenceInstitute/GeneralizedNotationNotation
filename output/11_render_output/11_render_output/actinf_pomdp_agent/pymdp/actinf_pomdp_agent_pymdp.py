...
class EnhancedPOMDPAgent:
    ...
    def _initialize_matrices(self):
        ...
        A = np.array([[0.9, 0.05, 0.05], [0.05, 0.9, 0.05], [0.05, 0.05, 0.9], [0.33, 0.33, 0.33]])
        A = A / A.sum(axis=1, keepdims=True)  # Normalize rows
        
        # B tensor: P(s'|s,a) - Transition model  
        B = np.array([[[0.8, 0.1, 0.1], [0.1, 0.8, 0.1], [0.1, 0.1, 0.8]], [[0.2, 0.3, 0.5], [0.2, 0.3, 0.5], [0.1, 0.1, 0.8]]])
...
def create_comprehensive_visualizations(results, output_dir):
    ...
    if ENHANCED_VIZ_AVAILABLE:
        ...
        viz_suite = EnhancedVisualizationSuite(output_dir, "pymdp_actinf_pomdp_agent")
...
def export_comprehensive_data(results, output_dir):
    ...
    if ENHANCED_VIZ_AVAILABLE:
        ...
        exporter = ComprehensiveDataExporter(output_dir, "pymdp_actinf_pomdp_agent")
        ...
        json_file = data_dir / "pymdp_actinf_pomdp_agent_basic_export.json"
...
def main():
    ...
    try:
        ...
        print("=" * 70)
        print(f"📁 Model: actinf_pomdp_agent")
        print(f"📄 Source: unknown.md")
        ...
        with open(summary_file, 'w') as f:
            ...
            f.write(f"**Model:** actinf_pomdp_agent\n")
