#!/usr/bin/env python3
"""
PyMDP Simulation Script for Two State Bistable POMDP
...
def main():
    ...
    A_matrix_data = [[0.8, 0.2], [0.2, 0.8]]  # Likelihood matrix P(o|s)
    B_matrix_data = [[[0.8, 0.3], [0.2, 0.7]], [[0.3, 0.8], [0.7, 0.2]]]  # Transition matrix P(s'|s,u)
    C_vector_data = [0.0, 2.0]  # Preferences over observations
    D_vector_data = [0.5, 0.5]  # Prior beliefs over states
    E_vector_data = [0.5, 0.5]  # Policy priors (habits)
    ...
    "variables": [
        {
            ...
            "type": "float",
            "comment": "Noisy observation of state"
        },
        {
            "name": "D",
            "dimensions": [
        ...
        },
        {
            ...
            "type": "float",
            "comment": "Action-dependent transitions"
        },
        {
            "name": "E",
            "dimensions": [
    ...
    # Output directory
    output_dir = Path("output") / "pymdp_simulations" / "Two State Bistable POMDP"
    output_dir.mkdir(parents=True, exist_ok=True)
    
    logger.info("Starting PyMDP simulation for Two State Bistable POMDP")
