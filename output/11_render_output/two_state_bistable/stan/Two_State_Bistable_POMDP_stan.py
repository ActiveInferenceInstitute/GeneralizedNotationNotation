#!/usr/bin/env python3
"""
Stan POMDP/HMM driver: Two State Bistable POMDP
...
STAN_FILE = Path(__file__).resolve().with_name('Two_State_Bistable_POMDP_stan.stan')
RANDOM_SEED = 42
T = 20
S, O, U = 2, 2, 2
PSEUDO_COUNT_STRENGTH = 20.0
NUTS_PARAM_BUDGET = 1024
A = np.asarray([[0.8, 0.2], [0.2, 0.8]], dtype=float)          # O x S, columns sum to 1
B = np.asarray([[[0.7272727272727273, 0.2727272727272727], [0.22222222222222227, 0.7777777777777778]], [[0.2727272727272727, 0.7272727272727273], [0.7777777777777778, 0.22222222222222227]]], dtype=float)          # S(next) x S(prev) x U
