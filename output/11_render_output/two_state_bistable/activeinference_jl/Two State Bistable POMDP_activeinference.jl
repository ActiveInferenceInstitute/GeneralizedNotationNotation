...
"""
ActiveInference.jl Script for GNN Model: Two State Bistable POMDP
...
B_matrix = cat([0.8 0.3; 0.2 0.7], [0.3 0.8; 0.7 0.2]; dims=3)
...
try
    ...
    n_steps = 20  # From GNN ModelParameters (num_timesteps)
    observations_log = []
    actions_log = []
    beliefs_log = []
    efe_log = []
