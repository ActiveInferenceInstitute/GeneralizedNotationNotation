...
def run_simulation():
    ...
    A = torch.tensor([
        [0.850000, 0.100000, 0.050000],
        [0.100000, 0.800000, 0.100000],
        [0.050000, 0.100000, 0.850000]
    ], dtype=torch.float64)
    C = torch.tensor([0.000000, 0.000000, 1.000000], dtype=torch.float64)
    D = torch.tensor([0.330000, 0.330000, 0.340000], dtype=torch.float64)
    ...
    B_slices.append(torch.tensor([
        [0.100000, 0.100000, 0.666667],
        [0.100000, 0.600000, 0.250000],
        [0.800000, 0.300000, 0.083333]
    ], dtype=torch.float64))
