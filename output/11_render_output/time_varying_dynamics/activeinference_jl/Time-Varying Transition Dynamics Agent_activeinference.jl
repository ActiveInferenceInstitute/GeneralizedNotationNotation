...
"""
ActiveInference.jl Script for GNN Model: Time-Varying Transition Dynamics Agent
...
A_matrix = [0.85 0.1 0.05; 0.1 0.8 0.1; 0.05 0.1 0.85]
println("✅ A matrix created: $(size(A_matrix))")

# B matrix (transition model) 
B_matrix = cat([0.6 0.3 0.1; 0.3 0.6 0.1; 0.1 0.1 0.8], [0.1 0.1 0.8; 0.1 0.6 0.3; 0.8 0.3 0.1]; dims=3)
...
try
    ...
    n_steps = 10  # From GNN ModelParameters (num_timesteps)
    observations_log = []
    actions_log = []
    beliefs_log = []
    efe_log = []
