#!/usr/bin/env python3
"""
Stan POMDP/HMM driver: Bnlearn Causal Model
...
STAN_FILE = Path(__file__).resolve().with_name('Bnlearn_Causal_Model_stan.stan')
RANDOM_SEED = 42
T = 30
S, O, U = 2, 2, 2
...
B = np.asarray([[[0.7, 0.3], [0.3, 0.7]], [[0.3, 0.7], [0.7, 0.3]]], dtype=float)          # S(next) x S(prev) x U
