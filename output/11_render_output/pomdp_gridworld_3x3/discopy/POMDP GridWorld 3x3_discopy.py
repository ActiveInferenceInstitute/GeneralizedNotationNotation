...
try:
    ...
    print(
        "DisCoPy is not installed. Install the project render extras before running this script."
    )
    sys.exit(1)
...
from discopy.monoidal import Box, Diagram, Id, Ty
...
print(
    f"📊 State Space: {NUM_STATES} states, {NUM_OBSERVATIONS} observations, {NUM_ACTIONS} actions"
)
...
def create_active_inference_circuit(S, O, A, P, components):
    ...
    perception_action_loop = state_inf >> policy_inf >> action_sel
    ...
    try:
        ...
        generative_model = (
            prior_block >> (state_inf @ Id(P)) >> policy_inf >> action_sel
        )
...
def main():
    ...
    print("Model: POMDP GridWorld 3x3")
    print("=" * 60)
