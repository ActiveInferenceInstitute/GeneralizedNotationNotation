#!/usr/bin/env python3
"""
Enhanced bnlearn causal analysis for POMDP GridWorld 3x3
...
class EnhancedPomdpGridworld3x3BnlearnAnalyzer:
    ...
    def create_and_analyze(self):
        ...
        df = pd.DataFrame(
            {"S_prev": s_prev_data, "A": a_data, "S": s_data, "O": o_data}
        )
        ...
        query = bn.inference.fit(
            model_mle, variables=["S"], evidence={"O": 1}, verbose=0
        )
...
if __name__ == "__main__":
    analyzer = EnhancedPomdpGridworld3x3BnlearnAnalyzer()
