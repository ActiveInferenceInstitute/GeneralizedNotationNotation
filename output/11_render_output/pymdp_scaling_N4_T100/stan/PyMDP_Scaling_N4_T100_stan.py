#!/usr/bin/env python3
"""
Stan POMDP/HMM driver: PyMDP Scaling N4 T100
...
STAN_FILE = Path(__file__).resolve().with_name('PyMDP_Scaling_N4_T100_stan.stan')
RANDOM_SEED = 42
T = 100
S, O, U = 4, 4, 4
PSEUDO_COUNT_STRENGTH = 20.0
NUTS_PARAM_BUDGET = 1024
A = np.asarray([[0.925, 0.025, 0.025, 0.025], [0.025, 0.925, 0.025, 0.025], [0.025, 0.025, 0.925, 0.025], [0.025, 0.025, 0.025, 0.925]], dtype=float)          # O x S, columns sum to 1
B = np.asarray([[[0.85, 0.05, 0.05, 0.05], [0.85, 0.05, 0.05, 0.05], [0.85, 0.05, 0.05, 0.05], [0.85, 0.05, 0.05, 0.05]], [[0.05, 0.85, 0.05, 0.05], [0.05, 0.85, 0.05, 0.05], [0.05, 0.85, 0.05, 0.05], [0.05, 0.85, 0.05, 0.05]], [[0.05, 0.05, 0.85, 0.05], [0.05, 0.05, 0.85, 0.05], [0.05, 0.05, 0.85, 0.05], [0.05, 0.05, 0.85, 0.05]], [[0.05, 0.05, 0.05, 0.85], [0.05, 0.05, 0.05, 0.85], [0.05, 0.05, 0.05, 0.85], [0.05, 0.05, 0.05, 0.85]]], dtype=float)          # S(next) x S(prev) x U
