#!/usr/bin/env python3
"""
Stan POMDP/HMM driver: Hidden Markov Model Baseline
...
STAN_FILE = Path(__file__).resolve().with_name('Hidden_Markov_Model_Baseline_stan.stan')
RANDOM_SEED = 42
T = 50
S, O, U = 4, 6, 1
PSEUDO_COUNT_STRENGTH = 20.0
NUTS_PARAM_BUDGET = 1024
A = np.asarray([[0.4666666666666666, 0.06666666666666667, 0.06666666666666667, 0.06666666666666667], [0.06666666666666667, 0.4666666666666666, 0.06666666666666667, 0.06666666666666667], [0.06666666666666667, 0.06666666666666667, 0.4666666666666666, 0.06666666666666667], [0.06666666666666667, 0.06666666666666667, 0.06666666666666667, 0.4666666666666666], [0.06666666666666667, 0.06666666666666667, 0.26666666666666666, 0.26666666666666666], [0.26666666666666666, 0.26666666666666666, 0.06666666666666667, 0.06666666666666667]], dtype=float)          # O x S, columns sum to 1
B = np.asarray([[[0.7000000000000001], [0.10000000000000002], [0.1], [0.1]], [[0.10000000000000002], [0.7000000000000001], [0.2], [0.1]], [[0.10000000000000002], [0.10000000000000002], [0.6], [0.2]], [[0.10000000000000002], [0.10000000000000002], [0.1], [0.6]]], dtype=float)          # S(next) x S(prev) x U
D = np.asarray([0.25, 0.25, 0.25, 0.25], dtype=float)          # S
