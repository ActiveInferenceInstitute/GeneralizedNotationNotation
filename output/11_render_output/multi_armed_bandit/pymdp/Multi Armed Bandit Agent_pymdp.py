#!/usr/bin/env python3
"""
PyMDP Simulation Script for Multi Armed Bandit Agent
...
def main():
    ...
    A_matrix_data = [[0.1, 0.5, 0.5], [0.3, 0.4, 0.3], [0.6, 0.1, 0.2]]  # Likelihood matrix P(o|s)
    B_matrix_data = [[[0.9, 0.05, 0.05], [0.05, 0.9, 0.05], [0.05, 0.05, 0.9]], [[0.9, 0.05, 0.05], [0.05, 0.9, 0.05], [0.05, 0.05, 0.9]], [[0.9, 0.05, 0.05], [0.05, 0.9, 0.05], [0.05, 0.05, 0.9]]]  # Transition matrix P(s'|s,u)
    C_vector_data = [0.0, 1.0, 3.0]  # Preferences over observations
    ...
    # Output directory
    output_dir = Path("output") / "pymdp_simulations" / "Multi Armed Bandit Agent"
    output_dir.mkdir(parents=True, exist_ok=True)
    
    logger.info("Starting PyMDP simulation for Multi Armed Bandit Agent")
