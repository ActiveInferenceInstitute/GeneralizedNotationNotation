...
- **B Matrix (Transition)**: 3×3 - State transitions given actions
...
- `Simple_Markov_Chain_stan.py` - stan simulation script
- `Simple_Markov_Chain_stan.stan` - stan simulation script
