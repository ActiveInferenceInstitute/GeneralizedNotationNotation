...
Generated from GNN Model: Active Inference Neural Response Model v1
...
def main():
    ...
    print(f"Model: Active Inference Neural Response Model v1")
    print("="*60)
