...
Generated from GNN POMDP Model: **PyMDP Scaling N128 T100**

## Model Information

- **Model Name**: PyMDP Scaling N128 T100
- **Model Description**: PyMDP runtime scaling sweep with noisy observation and stochastic transitions.
- **Generation Date**: 2026-05-06 07:04:33
...
- `PyMDP Scaling N128 T100_pymdp.py` - pymdp simulation script
