...
Generated from GNN POMDP Model: **PyMDP Scaling N16 T50**

## Model Information

- **Model Name**: PyMDP Scaling N16 T50
- **Model Description**: PyMDP runtime scaling sweep with noisy observation and stochastic transitions.
- **Generation Date**: 2026-05-06 07:04:28
...
- `PyMDP Scaling N16 T50_pymdp.py` - pymdp simulation script
