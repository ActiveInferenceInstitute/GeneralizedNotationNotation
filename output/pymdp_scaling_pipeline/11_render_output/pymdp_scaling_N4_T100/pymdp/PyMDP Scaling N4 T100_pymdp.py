#!/usr/bin/env python3
"""
pymdp 1.0.0 runner for PyMDP Scaling N4 T100
...
def main() -> int:
    ...
    A_data = [[0.925, 0.025, 0.025, 0.025], [0.025, 0.925, 0.025, 0.025], [0.025, 0.025, 0.925, 0.025], [0.025, 0.025, 0.025, 0.925]]
    B_data = [[[0.85, 0.05, 0.05, 0.05], [0.85, 0.05, 0.05, 0.05], [0.85, 0.05, 0.05, 0.05], [0.85, 0.05, 0.05, 0.05]], [[0.05, 0.85, 0.05, 0.05], [0.05, 0.85, 0.05, 0.05], [0.05, 0.85, 0.05, 0.05], [0.05, 0.85, 0.05, 0.05]], [[0.05, 0.05, 0.85, 0.05], [0.05, 0.05, 0.85, 0.05], [0.05, 0.05, 0.85, 0.05], [0.05, 0.05, 0.85, 0.05]], [[0.05, 0.05, 0.05, 0.85], [0.05, 0.05, 0.05, 0.85], [0.05, 0.05, 0.05, 0.85], [0.05, 0.05, 0.05, 0.85]]]
    ...
    gnn_spec = {
    "name": "PyMDP Scaling N4 T100",
    "model_name": "PyMDP Scaling N4 T100",
    ...
    output_dir = Path(os.environ.get("PYMDP_OUTPUT_DIR", "output/pymdp_simulations/PyMDP Scaling N4 T100"))
    output_dir.mkdir(parents=True, exist_ok=True)

    logger.info("Running pymdp 1.0.0 rollout for PyMDP Scaling N4 T100")
