...
Generated from GNN POMDP Model: **PyMDP Scaling N128 T10**

## Model Information

- **Model Name**: PyMDP Scaling N128 T10
- **Model Description**: PyMDP runtime scaling sweep with noisy observation and stochastic transitions.
- **Generation Date**: 2026-05-06 07:04:41
...
- `PyMDP Scaling N128 T10_pymdp.py` - pymdp simulation script
