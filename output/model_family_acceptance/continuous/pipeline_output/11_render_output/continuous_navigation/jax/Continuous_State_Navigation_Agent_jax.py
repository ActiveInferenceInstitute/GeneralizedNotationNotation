#!/usr/bin/env python3
"""
jax continuous (linear-Gaussian state-space) simulation: Continuous State Navigation Agent
...
Control: closed-loop u_t = 0.3 * (goal_mean - mu_t)
...
F_RAW = [[1.0, 0.0], [0.0, 1.0]]
H_RAW = [[1.0, 0.0], [0.0, 1.0]]
Q_RAW = [[0.05, 0.0], [0.0, 0.05]]
R_RAW = [[0.1, 0.0], [0.0, 0.1]]
PRIOR_MEAN_RAW = [0.0, 0.0]
PRIOR_COV_RAW = [[0.5, 0.0], [0.0, 0.5]]
GOAL_MEAN_RAW = [2.0, 2.0]
CONTROL_GAIN = 0.3
