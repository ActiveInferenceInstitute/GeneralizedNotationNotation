...
object ThreeLevelTemporalHierarchyAgentModel {
  ...
  // Morphisms
  val A_level0Too_level0: A_level0 => o_level0 = identity
  val A_level1Too_level1: A_level1 => o_level1 = identity
  val A_level2Too_level2: A_level2 => o_level2 = identity
  val B_level0Tou_level0: B_level0 => u_level0 = identity
  val B_level1Tou_level1: B_level1 => u_level1 = identity
  val B_level2Tou_level2: B_level2 => u_level2 = identity
  val C_level0ToG0: C_level0 => G0 = identity
  val C_level1ToG1: C_level1 => G1 = identity
  val C_level2ToG2: C_level2 => G2 = identity
  val D_level0Tos_level0: D_level0 => s_level0 = identity
  ...
  val pi0Tou_level0: pi0 => u_level0 = identity
  val pi1Tou_level1: pi1 => u_level1 = identity
  val pi2Tou_level2: pi2 => u_level2 = identity
  val s_level0ToA_level0: s_level0 => A_level0 = identity
  val s_level0Too_level1: s_level0 => o_level1 = identity
  val s_level1ToA_level1: s_level1 => A_level1 = identity
  val s_level1ToC_level0: s_level1 => C_level0 = identity
  val s_level1Too_level2: s_level1 => o_level2 = identity
  val s_level2ToA_level2: s_level2 => A_level2 = identity
  val s_level2ToC_level1: s_level2 => C_level1 = identity
  val s_level2ToD_level1: s_level2 => D_level1 = identity
