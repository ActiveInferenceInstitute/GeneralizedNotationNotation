...
repository state at commit 589aa9bd5, not typed by hand. The producer
...
state at commit 589aa9bd5, so each figure here is regenerated from the
...
directly from the tracked files at commit 589aa9bd5.
...
\breaktt{output/data/manuscript\_variables.json} (589aa9bd5): a code
