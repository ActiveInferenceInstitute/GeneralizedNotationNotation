...
repository state at commit 05689d7ad, not typed by hand. The producer
...
state at commit 05689d7ad, so each figure here is regenerated from the
...
directly from the tracked files at commit 05689d7ad.
...
The test suite comprises 369 test files containing 4144 test functions,
...
\breaktt{output/data/manuscript\_variables.json} (05689d7ad): a code
change that alters, for example, the test inventory (369 test files,
4144 test functions) propagates into the prose on the next regeneration
