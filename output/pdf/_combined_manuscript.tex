...
repository state at commit 360a666d0, not typed by hand. The producer
...
state at commit 360a666d0, so each figure here is regenerated from the
...
directly from the tracked files at commit 360a666d0.
...
exercising a source base of 672 Python files across 44 packages (197019
...
\breaktt{output/data/manuscript\_variables.json} (360a666d0): a code
...
into 44 Python packages spanning 672 source files and roughly 197019
