...
state at commit 043d5b96d, so each figure here is regenerated from the
...
directly from the tracked files at commit 043d5b96d.
...
exercising a source base of 589 Python files across 44 packages (195288
...
\breaktt{output/data/manuscript\_variables.json} (043d5b96d): a code
...
into 44 Python packages spanning 589 source files and roughly 195288
