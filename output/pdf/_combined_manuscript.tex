...
repository state at commit 0a0f0ac92, not typed by hand. The producer
...
state at commit 0a0f0ac92, so each figure here is regenerated from the
...
directly from the tracked files at commit 0a0f0ac92.
...
exercising a source base of 582 Python files across 31 packages (194817
...
\breaktt{output/data/manuscript\_variables.json} (0a0f0ac92): a code
...
into 31 Python packages spanning 582 source files and roughly 194817
