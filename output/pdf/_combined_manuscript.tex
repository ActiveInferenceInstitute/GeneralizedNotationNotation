...
generated from the producer's token map at commit a28701d0c. A
...
\protect\breaktt{src/gnn/STEP\_INDEX.md} at commit a28701d0c; its footer
...
producer tokens at commit a28701d0c, and the panel is generated by
...
model-family manifest at commit a28701d0c, and its footer summarizes the
...
repository state at commit a28701d0c, not typed by hand. The producer
...
state at commit a28701d0c, so each figure here is regenerated from the
...
a28701d0c.}\label{fig:family_matrix}
\end{figure}
...
a28701d0c --- the same token map that substitutes the prose counts, so
...
exercising a source base of 680 Python files across 44 packages (197837
...
\breaktt{output/data/manuscript\_variables.json} (a28701d0c): a code
...
into 44 Python packages spanning 680 source files and roughly 197837
