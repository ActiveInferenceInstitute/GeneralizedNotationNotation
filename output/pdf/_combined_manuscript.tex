...
generated from the producer's token map at commit dd6fb8ee3. A
...
\protect\breaktt{src/gnn/STEP\_INDEX.md} at commit dd6fb8ee3; its footer
...
producer tokens at commit dd6fb8ee3, and the panel is generated by
...
model-family manifest at commit dd6fb8ee3, and its footer summarizes the
...
repository state at commit dd6fb8ee3, not typed by hand. The producer
...
state at commit dd6fb8ee3, so each figure here is regenerated from the
...
dd6fb8ee3.}\label{fig:family_matrix}
\end{figure}
...
(\breaktt{ActiveInferenceInstitute/GEO_INFER} at a recorded revision) is
...
dd6fb8ee3 --- the same token map that substitutes the prose counts, so
...
\breaktt{output/data/manuscript\_variables.json} (dd6fb8ee3): a code
...
GNN 3.4.0 is a working system with deliberately scoped boundaries, and
...
The roadmap is concrete and staged. The current release is GNN 3.4.0
(``Model-Kind Truth'', 2026-09-17). It builds on the three
