...
repository state at commit 852f4bdbf, not typed by hand. The producer
...
state at commit 852f4bdbf, so each figure here is regenerated from the
...
directly from the tracked files at commit 852f4bdbf.
...
\breaktt{output/data/manuscript\_variables.json} (852f4bdbf): a code
