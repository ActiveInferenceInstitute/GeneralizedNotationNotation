...
generated from the producer's token map at commit c3e78f9c5. A
...
\protect\breaktt{src/gnn/STEP\_INDEX.md} at commit c3e78f9c5; its footer
...
producer tokens at commit c3e78f9c5, and the panel is generated by
...
model-family manifest at commit c3e78f9c5, and its footer summarizes the
...
repository state at commit c3e78f9c5, not typed by hand. The producer
...
state at commit c3e78f9c5, so each figure here is regenerated from the
...
c3e78f9c5.}\label{fig:family_matrix}
\end{figure}
...
c3e78f9c5 --- the same token map that substitutes the prose counts, so
...
exercising a source base of 679 Python files across 44 packages (197615
...
\breaktt{output/data/manuscript\_variables.json} (c3e78f9c5): a code
...
into 44 Python packages spanning 679 source files and roughly 197615
