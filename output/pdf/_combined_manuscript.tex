...
repository state at commit 046997962, not typed by hand. The producer
...
state at commit 046997962, so each figure here is regenerated from the
...
directly from the tracked files at commit 046997962.
...
The test suite comprises 450 test files containing 4809 test functions,
exercising a source base of 672 Python files across 44 packages (196787
...
\breaktt{output/data/manuscript\_variables.json} (046997962): a code
change that alters, for example, the test inventory (450 test files,
4809 test functions) propagates into the prose on the next regeneration
...
into 44 Python packages spanning 672 source files and roughly 196787
