...
repository state at commit b1aabb8c3, not typed by hand. The producer
...
state at commit b1aabb8c3, so each figure here is regenerated from the
...
directly from the tracked files at commit b1aabb8c3.
...
exercising a source base of 672 Python files across 44 packages (196733
...
\breaktt{output/data/manuscript\_variables.json} (b1aabb8c3): a code
...
into 44 Python packages spanning 672 source files and roughly 196733
