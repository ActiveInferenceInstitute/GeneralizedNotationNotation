...
repository state at commit 13c05e121, not typed by hand. The producer
...
state at commit 13c05e121, so each figure here is regenerated from the
...
directly from the tracked files at commit 13c05e121.
...
The test suite comprises 366 test files containing 4117 test functions,
exercising a source base of 582 Python files across 31 packages (194696
...
\breaktt{output/data/manuscript\_variables.json} (13c05e121): a code
change that alters, for example, the test inventory (366 test files,
4117 test functions) propagates into the prose on the next regeneration
...
into 31 Python packages spanning 582 source files and roughly 194696
...
files; \breaktt{input/multi\_agent\_models/} holds a compact acceptance
fixture that no manifest family registers, outside that count, and
...
section hard-codes one instead, and the resulting 84-entry map is
