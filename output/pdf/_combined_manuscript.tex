...
repository state at commit 1d4aaeec9, not typed by hand. The producer
...
state at commit 1d4aaeec9, so each figure here is regenerated from the
...
directly from the tracked files at commit 1d4aaeec9.
...
exercising a source base of 672 Python files across 44 packages (196793
...
\breaktt{output/data/manuscript\_variables.json} (1d4aaeec9): a code
...
into 44 Python packages spanning 672 source files and roughly 196793
