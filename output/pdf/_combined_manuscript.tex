...
repository state at commit dd195067f, not typed by hand. The producer
...
state at commit dd195067f, so each figure here is regenerated from the
...
directly from the tracked files at commit dd195067f.
...
The test suite comprises 373 test files containing 4155 test functions,
exercising a source base of 589 Python files across 44 packages (195362
...
across 32 modules. The pipeline itself runs as 25 steps (0--24), and
1991 figure artifacts from the rendering of figures, models, and reports
are committed under \texttt{output/}, of which 6 are the manuscript's
own.
...
into 44 Python packages spanning 589 source files and roughly 195362
...
dumps, intermediate representations, validation reports, and the 1991
