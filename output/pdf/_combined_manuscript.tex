...
repository state at commit 078c6d008, not typed by hand. The producer
...
state at commit 078c6d008, so each figure here is regenerated from the
...
directly from the tracked files at commit 078c6d008.
...
\breaktt{output/data/manuscript\_variables.json} (078c6d008): a code
