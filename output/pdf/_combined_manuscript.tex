...
generated from the producer's token map at commit 524b2e4af. A
...
\protect\breaktt{src/gnn/STEP\_INDEX.md} at commit 524b2e4af; its footer
...
producer tokens at commit 524b2e4af, and the panel is generated by
...
state at commit 524b2e4af, so each figure here is regenerated from the
...
524b2e4af.}\label{fig:family_matrix}
\end{figure}
...
524b2e4af --- the same token map that substitutes the prose counts, so
...
\breaktt{output/data/manuscript\_variables.json} (524b2e4af): a code
