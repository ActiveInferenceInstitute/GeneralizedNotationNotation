...
repository state at commit de89b7cb8, not typed by hand. The producer
...
state at commit de89b7cb8, so each figure here is regenerated from the
...
directly from the tracked files at commit de89b7cb8.
...
The test suite comprises 453 test files containing 4832 test functions,
exercising a source base of 677 Python files across 44 packages (197024
...
\breaktt{output/data/manuscript\_variables.json} (de89b7cb8): a code
change that alters, for example, the test inventory (453 test files,
4832 test functions) propagates into the prose on the next regeneration
...
into 44 Python packages spanning 677 source files and roughly 197024
