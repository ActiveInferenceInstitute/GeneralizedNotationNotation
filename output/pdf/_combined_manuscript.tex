...
repository state at commit bae612cea, not typed by hand. The producer
...
state at commit bae612cea, so each figure here is regenerated from the
...
directly from the tracked files at commit bae612cea.
...
The test suite comprises 452 test files containing 4827 test functions,
exercising a source base of 676 Python files across 44 packages (196777
...
\breaktt{output/data/manuscript\_variables.json} (bae612cea): a code
change that alters, for example, the test inventory (452 test files,
4827 test functions) propagates into the prose on the next regeneration
...
into 44 Python packages spanning 676 source files and roughly 196777
