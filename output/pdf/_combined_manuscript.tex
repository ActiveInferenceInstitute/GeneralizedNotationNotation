...
generated from the producer's token map at commit 0e2a2170d. A
...
\protect\breaktt{src/gnn/STEP\_INDEX.md} at commit 0e2a2170d; its footer
...
producer tokens at commit 0e2a2170d, and the panel is generated by
...
state at commit 0e2a2170d, so each figure here is regenerated from the
...
0e2a2170d.}\label{fig:family_matrix}
\end{figure}
...
0e2a2170d --- the same token map that substitutes the prose counts, so
...
\breaktt{output/data/manuscript\_variables.json} (0e2a2170d): a code
