module ActiveInferenceChronicPainMultiTheoryModelv1 where
...
-- Variable Types
data A = A Double
data Attn = Attn Double
data Auto = Auto Double
data B = B Double
data Behav = Behav Double
data C = C Double
data C_sens = C_sens Double
data Cog = Cog Double
data D = D Double
data D_mod = D_mod Double
data Desc_C = Desc_C Double
data E = E Double
data F = F Double
data Func = Func Double
data G = G Double
data G = G Double
data P_sens = P_sens Double
data Pain_I = Pain_I Double
data Pain_Q = Pain_Q Double
data Reapp = Reapp Double
data T = T Double
data t_fast = t_fast Double
data t_medium = t_medium Double
data t_slow = t_slow Double

-- Connections as Functions
DToT :: D -> T
DToT x = undefined  -- TODO: implement connection
DToP_sens :: D -> P_sens
DToP_sens x = undefined  -- TODO: implement connection
DToC_sens :: D -> C_sens
DToC_sens x = undefined  -- TODO: implement connection
DToCog :: D -> Cog
DToCog x = undefined  -- TODO: implement connection
TToP_sens :: T -> P_sens
TToP_sens x = undefined  -- TODO: implement connection
P_sensToB :: P_sens -> B
P_sensToB x = undefined  -- TODO: implement connection
P_sensToG :: P_sens -> G
P_sensToG x = undefined  -- TODO: implement connection
D_modToG :: D_mod -> G
D_modToG x = undefined  -- TODO: implement connection
GToB :: G -> B
GToB x = undefined  -- TODO: implement connection
GToC_sens :: G -> C_sens
GToC_sens x = undefined  -- TODO: implement connection
C_sensToB :: C_sens -> B
C_sensToB x = undefined  -- TODO: implement connection
TToC_sens :: T -> C_sens
TToC_sens x = undefined  -- TODO: implement connection
CogToD_mod :: Cog -> D_mod
CogToD_mod x = undefined  -- TODO: implement connection
D_modToB :: D_mod -> B
D_modToB x = undefined  -- TODO: implement connection
Pain_IToCog :: Pain_I -> Cog
Pain_IToCog x = undefined  -- TODO: implement connection
FuncToCog :: Func -> Cog
FuncToCog x = undefined  -- TODO: implement connection
CogToB :: Cog -> B
CogToB x = undefined  -- TODO: implement connection
TToA :: T -> A
TToA x = undefined  -- TODO: implement connection
P_sensToA :: P_sens -> A
P_sensToA x = undefined  -- TODO: implement connection
GToA :: G -> A
GToA x = undefined  -- TODO: implement connection
C_sensToA :: C_sens -> A
C_sensToA x = undefined  -- TODO: implement connection
D_modToA :: D_mod -> A
D_modToA x = undefined  -- TODO: implement connection
CogToA :: Cog -> A
CogToA x = undefined  -- TODO: implement connection
AttnToCog :: Attn -> Cog
AttnToCog x = undefined  -- TODO: implement connection
BehavToT :: Behav -> T
BehavToT x = undefined  -- TODO: implement connection
BehavToFunc :: Behav -> Func
BehavToFunc x = undefined  -- TODO: implement connection
ReappToCog :: Reapp -> Cog
ReappToCog x = undefined  -- TODO: implement connection
Desc_CToD_mod :: Desc_C -> D_mod
Desc_CToD_mod x = undefined  -- TODO: implement connection
CToG :: C -> G
CToG x = undefined  -- TODO: implement connection
EToAttn :: E -> Attn
EToAttn x = undefined  -- TODO: implement connection
EToBehav :: E -> Behav
EToBehav x = undefined  -- TODO: implement connection
GToAttn :: G -> Attn
GToAttn x = undefined  -- TODO: implement connection
GToBehav :: G -> Behav
GToBehav x = undefined  -- TODO: implement connection
GToReapp :: G -> Reapp
GToReapp x = undefined  -- TODO: implement connection
GToDesc_C :: G -> Desc_C
GToDesc_C x = undefined  -- TODO: implement connection
AttnToBehav :: Attn -> Behav
AttnToBehav x = undefined  -- TODO: implement connection
BehavToReapp :: Behav -> Reapp
BehavToReapp x = undefined  -- TODO: implement connection
ReappToDesc_C :: Reapp -> Desc_C
ReappToDesc_C x = undefined  -- TODO: implement connection
