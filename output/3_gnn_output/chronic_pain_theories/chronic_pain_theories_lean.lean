...
namespace ActiveInferenceChronicPainMultiTheoryModelv1
...
structure ActiveInferenceChronicPainMultiTheoryModelv1Model where
  A : ℝ
  Attn : ℝ
  Auto : ℝ
  B : ℝ
...
end ActiveInferenceChronicPainMultiTheoryModelv1
