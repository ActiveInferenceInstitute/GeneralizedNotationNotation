theory DirichletLikelihoodLearningAgent
imports Main
begin

text \<open>Dirichlet Likelihood Learning Agent\<close>
text \<open>This model describes a discrete POMDP agent that learns its observation model:
...
- Inference: structured VMP with mean-field cut q(s, A) = q(s)q(A),
  q(A) initialized at the prior counts, q(s) initialized uniform.\<close>
