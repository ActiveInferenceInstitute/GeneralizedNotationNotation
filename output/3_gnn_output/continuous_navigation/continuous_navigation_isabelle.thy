...
text \<open>A continuous-state Active Inference navigation agent rendered as a native
...
- The controller closes the loop on beliefs — it pushes the filtered posterior
  ...
  gain control_gain = 0.3, i.e. u_t = control_gain * (goal_mean - mu_t).\<close>

type_synonym F = "real"
type_synonym H = "real"
type_synonym Q = "real"
type_synonym R = "real"
type_synonym control_gain = "real"
type_synonym goal_mean = "real"
