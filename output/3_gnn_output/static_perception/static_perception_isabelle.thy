theory StaticPerceptionModel
imports Main
begin

text \<open>Static Perception Model\<close>
text \<open>The simplest Active Inference model demonstrating pure perception:
...
- Suitable as a minimal baseline and for testing perception-only inference\<close>
