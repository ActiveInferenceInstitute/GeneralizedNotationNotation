theory MultiAgentCoordinationAcceptanceFixture
imports Main
begin

text \<open>Multi-Agent Coordination Acceptance Fixture\<close>
text \<open>Compact fixture for RxInfer and DisCoPy roadmap acceptance tests.\<close>

type_synonym o = "nat list"
type_synonym s = "nat list"
type_synonym u = "nat list"
