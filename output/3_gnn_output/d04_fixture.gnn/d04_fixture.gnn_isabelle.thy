theory NESTD04Synthetic2StateLGSSM
imports Main
begin

text \<open>NEST D04 Synthetic 2-State LGSSM\<close>
text \<open>Passive linear-Gaussian state-space model (no control input) generating the
...
Deliverable D04 (AII); pattern for D07 (3–5 states) and D14 (GNN → RxInfer render).\<close>
