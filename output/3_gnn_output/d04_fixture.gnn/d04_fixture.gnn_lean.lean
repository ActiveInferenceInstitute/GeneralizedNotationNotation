-- GNN Model in Lean 4
-- Model: NEST D04 Synthetic 2-State LGSSM
...
namespace NESTD04Synthetic2StateLGSSM
...
structure NESTD04Synthetic2StateLGSSMModel where
  F : ℝ
  H : ℝ
  Q : ℝ
  R : ℝ
...
end NESTD04Synthetic2StateLGSSM
