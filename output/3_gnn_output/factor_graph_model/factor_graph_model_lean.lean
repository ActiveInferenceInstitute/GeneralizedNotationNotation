-- GNN Model in Lean 4
-- Model: Factor Graph Active Inference Model
...
namespace FactorGraphActiveInferenceModel
...
variable (F : ℝ)
variable (G : ℝ)
variable (m_pos_to_vis : ℝ)
variable (m_prop_to_vel : ℝ)
variable (m_vel_to_prop : ℝ)
variable (m_vis_to_pos : ℝ)
variable (o_prop : ℝ)
variable (o_vis : ℤ)
variable (s_pos : ℝ)
variable (s_vel : ℝ)
...
structure FactorGraphActiveInferenceModelModel where
  A_prop : ℝ
  A_vis : ℝ
  B_pos : ℝ
  B_vel : ℝ
...
end FactorGraphActiveInferenceModel
