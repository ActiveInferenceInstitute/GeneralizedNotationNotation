...
object FactorGraphActiveInferenceModelModel {
  ...
  type F = Any
  type G = Any
  type m_pos_to_vis = Any
  type m_prop_to_vel = Any
  type m_vel_to_prop = Any
  type m_vis_to_pos = Any
  type o_prop = Any
  type o_vis = Any
  type s_pos = Any
  type s_vel = Any
