theory PyMDPScalingN2T100
imports Main
begin

text \<open>PyMDP Scaling N2 T100\<close>
text \<open>PyMDP runtime scaling sweep with noisy observation and stochastic transitions.\<close>
