theory TwoStateBistablePOMDP
imports Main
begin

text \<open>Two State Bistable POMDP\<close>
text \<open>This model describes a minimal 2-state bistable POMDP:
...
- Tests the absolute smallest POMDP with full active inference structure.\<close>
