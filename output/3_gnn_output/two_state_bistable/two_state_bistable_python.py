...
Generated: 2026-09-05T20:30:54.029419
"""

import numpy as np
from typing import Dict, List, Any

class TwoStateBistablePOMDPModel:
    """GNN Model: Two State Bistable POMDP"""

    def __init__(self):
        self.model_name = "Two State Bistable POMDP"
        self.version = "1.0"
        self.annotation = "This model describes a minimal 2-state bistable POMDP:\n\n- 2 hidden states: \"left\" and \"right\" in a symmetric bistable potential.\n- 2 noisy observations: the agent gets a noisy readout of which side it is on.\n- 2 actions: push-left or push-right.\n- The agent prefers observation 1 (\"right\") over observation 0 (\"left\").\n- Tests the absolute smallest POMDP with full active inference structure."
        ...
        self.variables = {
            "A": {
                ...
                "data_type": "float",
                "dimensions": [2, 2],
                "description": "Noisy observation of state",
            },
            "B": {
                "type": "transition_matrix",
                "data_type": "float",
                "dimensions": [2, 2, 2],
                "description": "Action-dependent transitions",
            },
            "C": {
                "type": "preference_vector",
                "data_type": "float",
                "dimensions": [2],
                "description": "Prefer right side",
            },
            "D": {
                "type": "prior_vector",
                "data_type": "float",
            ...
            "E": {
                ...
                "data_type": "float",
                "dimensions": [2],
                "description": "Prior over actions",
            },
            "G": {
                "type": "policy",
                "data_type": "float",
            ...
            "s": {
                ...
                "data_type": "float",
                "dimensions": [2, 1],
                "description": "Current state belief",
            },
            "s_prime": {
                "type": "hidden_state",
                "data_type": "float",
                "dimensions": [2, 1],
                "description": "Next state belief",
            },
            "t": {
                "type": "hidden_state",
                "data_type": "integer",
            ...
            "π": {
                ...
                "data_type": "float",
                "dimensions": [2],
                "description": "Policy over actions",
            },
        }
