theory TimeVaryingTransitionDynamicsAgent
imports Main
begin

text \<open>Time-Varying Transition Dynamics Agent\<close>
text \<open>A POMDP agent operating in a non-stationary environment. The key feature
...
timestep-dependent.\<close>

type_synonym A = "real"
type_synonym B_t = "real"
type_synonym C = "real"
type_synonym D = "real"
type_synonym o_t = "int"
type_synonym s_t = "real"
type_synonym s_t+1 = "real"
type_synonym u_t = "int"
