theory MultiArmedBanditAgent
imports Main
begin

text \<open>Multi Armed Bandit Agent\<close>
text \<open>This model describes a 3-armed bandit as a degenerate POMDP:
...
- Tests the bandit structure: meaningful actions despite nearly-static state dynamics.\<close>
