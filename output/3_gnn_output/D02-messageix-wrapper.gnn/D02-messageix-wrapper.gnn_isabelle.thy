theory MESSAGEixNationalWrapperBlanket
imports Main
begin

text \<open>MESSAGEix National Wrapper Blanket\<close>
text \<open>Markov blanket for MESSAGEix as a coupled component in NEST Stage 1.
