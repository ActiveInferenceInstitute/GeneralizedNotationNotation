-- GNN Model in Lean 4
-- Model: MESSAGEix National Wrapper Blanket
...
namespace MESSAGEixNationalWrapperBlanket
...
structure MESSAGEixNationalWrapperBlanketModel where
  J : ℝ
  K : ℝ
  cap : ℝ
  d : ℝ
...
end MESSAGEixNationalWrapperBlanket
