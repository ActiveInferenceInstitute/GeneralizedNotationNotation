-- GNN Model in Lean 4
-- Model: STURM Building-Stock Wrapper Blanket
...
namespace STURMBuildingStockWrapperBlanket
...
structure STURMBuildingStockWrapperBlanketModel where
  d : ℝ
  p : ℝ
  q : ℝ
  r : ℝ
...
end STURMBuildingStockWrapperBlanket
