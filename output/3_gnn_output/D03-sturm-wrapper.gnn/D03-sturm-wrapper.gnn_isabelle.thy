theory STURMBuildingStockWrapperBlanket
imports Main
begin

text \<open>STURM Building-Stock Wrapper Blanket\<close>
text \<open>Markov blanket for STURM as a coupled component in NEST Stage 1.
