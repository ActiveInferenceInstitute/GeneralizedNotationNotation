theory HiddenMarkovModelBaseline
imports Main
begin

text \<open>Hidden Markov Model Baseline\<close>
text \<open>A standard discrete Hidden Markov Model with:
...
- Suitable for sequence modeling and state estimation tasks\<close>

type_synonym A = "real"
type_synonym B = "real"
type_synonym D = "real"
type_synonym F = "real"
type_synonym alpha = "real"
type_synonym beta = "real"
type_synonym o = "int"
type_synonym s = "real"
