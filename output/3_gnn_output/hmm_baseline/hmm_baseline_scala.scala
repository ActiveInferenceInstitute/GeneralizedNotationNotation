...
object HiddenMarkovModelBaselineModel {
  ...
  val alphaTos_prime: alpha => s_prime = identity
  val oToF: o => F = identity
  val oToalpha: o => alpha = identity
  val sToA: s => A = identity
  val sToB: s => B = identity
  val sToF: s => F = identity
  val sToalpha: s => alpha = identity
  val sTos_prime: s => s_prime = identity
  val s_primeTobeta: s_prime => beta = identity
