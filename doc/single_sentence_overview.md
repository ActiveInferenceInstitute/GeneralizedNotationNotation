...
| **🔗 iroh** | [iroh.md](iroh/iroh.md) | Iroh peer-to-peer networking integration for distributed models | Enables decentralized Active Inference agent coordination | 🟠 Distributed |
...
| **🔌 nock** | [nock-gnn.md](nock/nock-gnn.md) | Nock formal specification language integration | Enables zero-knowledge blockchain-based specification of Active Inference models | 🔵 Formal |
...
| **📂 onefilellm** | [onefilellm_gnn.md](onefilellm/onefilellm_gnn.md) | Single-file LLM wrapper for Active Inference model analysis | Simplifies AI-assisted model interpretation and annotation | 🟠 Utility |
...
| **⏰ timep** | [timep_gnn.md](timep/timep_gnn.md) | Temporal modeling and time series analysis for dynamical systems | Enables precise specification of continuous and discrete time dynamics | 🟡 Temporal |
