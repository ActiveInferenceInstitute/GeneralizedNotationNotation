...
Pickle format serialization for GNN models

## Overview

This directory contains documentation, resources, and implementation guides for the pkl subsystem.

**Contents**:        3 files,        2 subdirectories
