...
* **GNN File Structure:** GNN files are typically Markdown (`.md`) and organized into specific sections, such as:
  ...
  * Refer to `doc/gnn/reference/gnn_file_structure_doc.md` for file layout (and `src/gnn/documentation/file_structure.md` for the parser-facing copy under `src/gnn/`).
* **GNN Syntax and Punctuation:** Normative syntax in `doc/gnn/reference/gnn_syntax.md`; punctuation rules in `src/gnn/documentation/punctuation.md` (also exposed via MCP `get_gnn_documentation("punctuation")`).
...
* **Provide GNN Schema:** Include or reference key parts of `doc/gnn/reference/gnn_file_structure_doc.md`, `doc/gnn/reference/gnn_syntax.md`, and `src/gnn/documentation/punctuation.md`.
