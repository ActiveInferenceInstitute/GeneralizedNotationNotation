...
GUI interface using Oxdraw for GNN model construction

## Overview

This directory contains documentation, resources, and implementation guides for the gui_oxdraw subsystem.

**Contents**:        3 files,        1 subdirectories
