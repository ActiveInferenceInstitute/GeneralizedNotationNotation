...
uv run python src/5_type_checker.py --target-dir input/gnn_files --estimate-resources --verbose
...
*(For precise calculation formulas, refer to the implementation in `src/type_checker/resource_estimator.py`.)*
