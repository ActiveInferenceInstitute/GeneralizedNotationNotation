...
**Key Topics**:
- High-level coherence metrics (24 steps, 28 modules, 41 AGENTS.md files)
...
- **By Pipeline Step**: All 24 steps covered
...
All GNN documentation agents integrate with the 24-step processing pipeline:

```
Documentation Layer (23 agents)
          ↓
Pipeline Infrastructure (24 steps, 28 modules)
          ↓
