...
flowchart TD
    ...
    D -->|GPU Acceleration| I2[JAX Integration]
    D -->|Deep Learning| I3[PyTorch Integration]
    D -->|Probabilistic| I4[NumPyro Integration]
    E --> I[PyMDP Simulation]
    F --> J[RxInfer Simulation]
    G --> K[DisCoPy Evaluation]
    H --> L[ActiveInference.jl Simulation]
    I2 --> K2[JAX Simulation]
    I3 --> K3[PyTorch Simulation]
    I4 --> K4[NumPyro Simulation]
...
class FrameworkBenchmark:
    ...
    def __init__(self):
        self.frameworks = ['pymdp', 'rxinfer', 'discopy', 'jax', 'activeinference_jl', 'pytorch', 'numpyro']
