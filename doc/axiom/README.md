...
Axiom formalization and GNN representations

## Overview

This directory contains documentation, resources, and implementation guides for the axiom subsystem.

**Contents**:        2 files,        2 subdirectories
