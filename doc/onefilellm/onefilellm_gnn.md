...
uv pip install -r requirements.txt  # see req list[17]
...
```bash
# STEP 0: install
uv pip install -r onefilellm/requirements.txt
uv pip install torch pymdp rich
...
[17] <https://github.com/jimmc414/onefilellm/blob/main/requirements.txt>
