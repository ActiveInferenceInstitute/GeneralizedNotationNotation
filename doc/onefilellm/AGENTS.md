...
This directory contains documentation and resources for the onefilellm subsystem.
...
OneFileLLM - Single-file LLM wrapper for Active Inference model analysis
