# Cerebrum Cognitive Architecture Documentation Agents

## Overview

This document provides agent scaffolding for the Cerebrum Cognitive Architecture documentation subsystem. The documentation is organized into specialized agent modules, each responsible for specific aspects of the Cerebrum Cognitive Architecture system.
...
Documentation for the Cerebrum cognitive architecture and its GNN implementations.
...
- **cerebrum_v1-4.md**: Complete Cerebrum specification (versions 1-4)
- **gnn_cerebrum.md**: Cerebrum models in GNN notation
