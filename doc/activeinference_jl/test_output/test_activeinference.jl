...
Test GNN model for ActiveInference.jl
...
A_matrix = [[0.9, 0.1, 0.0], [0.0, 0.9, 0.1], [0.1, 0.0, 0.9]]
println("✅ A matrix created: $(size(A_matrix))")

# B matrix (transition model) 
B_matrix = [[[0.9, 0.1, 0.0], [0.0, 0.9, 0.1], [0.1, 0.0, 0.9]], [[0.1, 0.0, 0.9], [0.9, 0.1, 0.0], [0.0, 0.9, 0.1]]]
