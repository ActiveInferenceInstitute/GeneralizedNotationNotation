...
Kit framework and tooling

## Overview

This directory contains documentation, resources, and implementation guides for the kit subsystem.

**Contents**:        1 files,        2 subdirectories
