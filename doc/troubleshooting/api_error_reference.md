...
class InvalidHeaderError(GNNSyntaxError):
    ...
    def __init__(self, header: str, line_number: int = None, file_path: str = None):
...
class MalformedVariableError(GNNSyntaxError):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            file_path=file_path,
            line_number=line_number,
            context={"variable_declaration": variable_declaration, "issue": issue},
        )
...
class InvalidConnectionError(GNNSyntaxError):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            file_path=file_path,
            line_number=line_number,
            context={"connection": connection, "issue": issue},
        )
```
...
class DimensionMismatchError(GNNValidationError):
    ...
    def __init__(
        ...
        message = (
            f"Dimension mismatch in {matrix_name}: "
...
class ConnectionValidationError(GNNValidationError):
    ...
    def __init__(
        self, connection: str, undefined_variables: list, file_path: str = None
    ):
...
class PipelineExecutionError(GNNRuntimeError):
    ...
    def __init__(
        self, step_name: str, step_number: int, exit_code: int, stderr: str = None
    ):
...
class ResourceExhaustionError(GNNRuntimeError):
    ...
    def __init__(self, resource_type: str, current_usage: str, limit: str = None):
...
class DependencyError(GNNRuntimeError):
    ...
    def __init__(
        ...
        if issue:
            ...
            message = (
                f"Version mismatch for {dependency_name}: "
...
class PyMDPIntegrationError(GNNIntegrationError):
    ...
    def __init__(self, operation: str, details: str):
        ...
        super().__init__(
            message=message,
            error_code="INT-101",
            context={"operation": operation, "details": details, "framework": "PyMDP"},
        )
...
class MemoryWarning(GNNPerformanceWarning):
    ...
    def __init__(self, current_mb: float, threshold_mb: float):
        message = (
            f"High memory usage: {current_mb:.1f}MB (threshold: {threshold_mb:.1f}MB)"
        )
        super().__init__(
            message=message,
