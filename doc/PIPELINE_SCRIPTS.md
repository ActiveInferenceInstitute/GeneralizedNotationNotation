...
**Authoritative step matrix** (timeouts, dependencies, recovery): [`src/STEP_INDEX.md`](../src/STEP_INDEX.md). **Canonical step registry** (single source of truth for all 25 steps): [`src/pipeline/step_registry.py`](../src/pipeline/step_registry.py). **Commands and test notes**: [`CLAUDE.md`](../CLAUDE.md).
