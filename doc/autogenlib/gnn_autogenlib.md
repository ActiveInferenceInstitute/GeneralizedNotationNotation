...
* **GNN Syntax and Punctuation:** Normative syntax in `doc/gnn/gnn_syntax.md`; punctuation rules in `src/gnn/documentation/punctuation.md` (also exposed via MCP `get_gnn_documentation("punctuation")`).
...
* **Provide GNN Schema:** Include or reference key parts of `doc/gnn/reference/gnn_file_structure_doc.md`, `doc/gnn/gnn_syntax.md`, and `src/gnn/documentation/punctuation.md`.
