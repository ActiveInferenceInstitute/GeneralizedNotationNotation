...
Category theory and DisCoPy string diagram integration

## Overview

This directory contains documentation, resources, and implementation guides for the discopy subsystem.
