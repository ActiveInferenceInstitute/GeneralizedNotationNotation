# DisCoPy Category Theory Documentation Agents

## Overview

This document provides agent scaffolding for the DisCoPy Category Theory documentation subsystem. The documentation is organized into specialized agent modules, each responsible for specific aspects of the DisCoPy Category Theory system.
...
Documentation for integrating DisCoPy (string diagrams and category theory) with GNN.

## Documentation Organization

The DisCoPy Category Theory documentation system is part of the broader GNN (Generalized Notation Notation) pipeline and ecosystem.
