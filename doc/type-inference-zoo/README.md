...
Type inference systems and implementation collection

## Overview

This directory contains documentation, resources, and implementation guides for the type-inference-zoo subsystem.
