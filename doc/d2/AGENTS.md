# D2 Diagram Language Documentation Agents

## Overview

This document provides agent scaffolding for the D2 Diagram Language documentation subsystem. The documentation is organized into specialized agent modules, each responsible for specific aspects of the D2 Diagram Language system.
...
Documentation for D2 diagram language integration with GNN visualization.

## Documentation Organization

The D2 Diagram Language documentation system is part of the broader GNN (Generalized Notation Notation) pipeline and ecosystem.
...
- **d2.md**: D2 language reference
- **gnn_d2.md**: GNN to D2 diagram generation
