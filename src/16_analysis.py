...
This step orchestrates comprehensive analysis and statistical processing for GNN models.
It is a thin orchestrator that delegates core functionality to the analysis module.
...
Expected outputs:
  - Statistical analysis results in the specified output directory
  - Complexity metrics and performance benchmarks
  - Model comparison reports
  - Actionable error messages if dependencies or paths are missing
  - Clear logging of all resolved arguments and paths

If you encounter errors:
  - Check that numpy and required analysis libraries are installed
...
# Import the analysis processor
from analysis import process_analysis

def process_analysis_standardized(
    target_dir: Path,
    output_dir: Path,
    ...
    **kwargs
    ...
    try:
        ...
        # Process files using the analysis module
        ...
        if success:
            log_step_success(logger, f"Successfully analyzed {len(gnn_files)} GNN models")
        else:
...
def main():
    ...
    try:
        ...
        success = process_analysis_standardized(
