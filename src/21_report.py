#!/usr/bin/env python3
"""
Step 21: Report Generation (Thin Orchestrator)
...
How to run:
  python src/21_report.py --target-dir input/gnn_files --output-dir output --verbose
...
If you encounter errors:
  ...
  - Verify report template configuration and data sources
"""
...
def process_report_standardized(
    ...
    **kwargs
    ...
    """
    Standardized report generation function.
    ...
    try:
        ...
        logger.info(f"Found {len(gnn_files)} GNN files to process for report generation")
        
        # Process files using the report module
