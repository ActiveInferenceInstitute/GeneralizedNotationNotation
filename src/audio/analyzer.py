...
def process_gnn_to_audio(
    gnn_content: str, model_name: str | None = None, output_dir: str | None = None
) -> Dict[str, Any]:
    """
    ...
    try:
        ...
        if not gnn_content.strip():
            return {"success": False, "error": "Empty GNN content provided"}
...
def convert_gnn_to_sapf(gnn_content: str, output_dir: Path) -> Dict[str, Any]:
    ...
    try:
        ...
        return {"success": False, "error": f"SAPF conversion failed: {str(e)}"}


def generate_audio_from_sapf(
    sapf_config: Dict[str, Any], output_dir: Path
) -> Dict[str, Any]:
    """
    ...
    try:
        ...
        return {"success": False, "error": f"SAPF audio generation failed: {str(e)}"}
