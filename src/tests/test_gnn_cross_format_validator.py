...
class TestCrossFormatValidationResult:
    def test_default_consistency_rate_no_formats(self):
    ...
    def test_consistency_rate_all_valid(self):
    ...
    def test_consistency_rate_format_not_in_results(self):
...
class TestCrossFormatValidator:
    ...
    def test_instantiation_with_round_trip(self):
        v = CrossFormatValidator(enable_round_trip_testing=True)
        assert v.enable_round_trip_testing is True

    def test_validate_cross_format_consistency_returns_result(self):
    ...
    def test_validate_cross_format_consistency_has_metadata(self):
    ...
    def test_validate_cross_format_schema_files_absent_no_crash(self):
    ...
    def test_validate_cross_format_consistency_is_bool(self):
