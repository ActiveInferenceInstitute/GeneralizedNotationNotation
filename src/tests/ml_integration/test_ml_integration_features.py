...
def test_extract_gnn_features_full_block_dimensions(tmp_path: Path) -> None:
    from ml_integration import extract_gnn_features
...
def test_detect_model_family_section_variants() -> None:
    from ml_integration.processor import _detect_model_family
...
def test_count_connections_directed_vs_undirected() -> None:
    from ml_integration.processor import _count_connections
...
def test_extract_planning_horizon_variants() -> None:
    from ml_integration.processor import _extract_planning_horizon
...
def test_extract_time_type_bare_lines() -> None:
    from ml_integration.processor import _extract_time_type
...
def test_feature_vector_order_matches_numeric_feature_names() -> None:
    from ml_integration import NUMERIC_FEATURE_NAMES, feature_vector
...
def test_complexity_label_boundaries() -> None:
    from ml_integration import complexity_label
...
def test_summarize_features_min_max_mean() -> None:
    from ml_integration import summarize_features
...
def test_structural_analysis_entries_shape_and_note() -> None:
    from ml_integration.processor import _structural_analysis_entries
