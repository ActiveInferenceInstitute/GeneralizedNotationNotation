...
class TestUtilsResourceManager:
    ...
    def test_resource_manager_class(self) -> None:
        ...
        from src.utils.resource_manager import get_current_memory_usage, get_system_info
...
def test_pipeline_infrastructure_completeness() -> None:
    ...
    expected_modules = [('pipeline', ['discovery', 'pipeline_validation', 'verify_pipeline']), ('utils', ['migration_helper', 'pipeline_monitor', 'resource_manager', 'script_validator'])]
    available_modules = []
