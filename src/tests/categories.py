...
MODULAR_TEST_CATEGORIES: Dict[str, Dict[str, Any]] = {
    ...
    "visualization": {
        ...
        "files": [
            "test_visualization_overall.py",
            "test_visualization_matrices.py",
            "test_visualization_ontology.py",
            "test_visualization_comprehensive.py",
            "test_d2_visualizer.py",
    ...
    "pipeline": {
        ...
        "files": [
            ...
            "test_pipeline_infrastructure.py",
            "test_pipeline_functionality.py",
            "test_pipeline_render_execute_analyze.py",
            "test_pipeline_error_scenarios.py",
            "test_pipeline_improvements_validation.py",
            "test_pipeline_main.py",
            "test_pipeline_warnings_fix.py",
    ...
    "llm": {
        ...
        "files": [
            "test_llm_overall.py",
            "test_llm_ollama.py",
            "test_llm_ollama_integration.py",
        ],
        "markers": [],
        "timeout_seconds": 120,
        "max_failures": 8,
