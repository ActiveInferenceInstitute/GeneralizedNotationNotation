...
def test_atomic_receipt_serialization_failure_preserves_previous(
    ...
    from execute.metadata import _atomic_execution_json
    from render.processor import _atomic_render_json
...
def test_execution_atomic_writer_emits_current_receipt(tmp_path: Path) -> None:
    from execute.processor import _write_execution_summaries
