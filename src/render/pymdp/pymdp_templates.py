...
# robust import strategy for pymdp
try:
    ...
    try:
        ...
        logger.error(f"Failed to import PyMDP: {{e}}")
        logger.error("Please install inferactively-pymdp: uv pip install inferactively-pymdp")
        sys.exit(1)
"""
