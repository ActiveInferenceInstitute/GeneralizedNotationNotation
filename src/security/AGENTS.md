...
- `src/tests/security/test_security_policy_and_source.py` - Policy resolver, severity helpers, `scan_source`, typed errors, permission semantics (added 1.7.0)
