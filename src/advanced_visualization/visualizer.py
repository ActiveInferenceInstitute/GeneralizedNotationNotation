...
class AdvancedVisualizer:
    ...
    def generate_visualizations(
        ...
        try:
            stats_files = self._generate_statistical_visualizations(
                extracted_data, model_name, model_output_dir
            )
            generated.extend(stats_files)
        except Exception as e:
            self.logger.warning(
                f"Statistical visualizations failed for {model_name}: {e}"
            )

        # Generate network visualizations
        try:
            network_files = self._generate_network_visualizations(
                extracted_data, model_name, model_output_dir
            )
        ...
        try:
            matrix_files = self._generate_matrix_visualizations(
                extracted_data, model_name, model_output_dir
            )
...
"""
    ...
    def _generate_statistical_visualizations(
        ...
        try:
            ...
            if matplotlib:
                stats_file = self._create_statistics_plot(
                    extracted_data, model_name, output_dir
                )
                if stats_file:
    ...
    def _generate_network_visualizations(
        self, extracted_data: Dict[str, Any], model_name: str, output_dir: Path
    ) -> List[str]:
        """Generate network visualizations"""
        generated = []
        ...
        try:
            ...
            if matplotlib and numpy:
                network_file = self._create_network_graph(
                    extracted_data, model_name, output_dir
                )
                if network_file:
    ...
    def _generate_matrix_visualizations(
        self, extracted_data: Dict[str, Any], model_name: str, output_dir: Path
    ) -> List[str]:
        """Generate matrix visualizations"""
        generated = []
        ...
        try:
            ...
            if matplotlib and numpy:
                matrix_file = self._create_matrix_heatmap(
                    extracted_data, model_name, output_dir
                )
                if matrix_file:
