#!/usr/bin/env python3
"""
Step 21: Model Context Protocol Processing (Thin Orchestrator)
...
def main():
    ...
    args = EnhancedArgumentParser.parse_step_arguments("21_mcp")
    ...
    try:
        ...
        config = get_pipeline_config()
        output_dir = get_output_dir_for_script("21_mcp.py", Path(args.output_dir))
