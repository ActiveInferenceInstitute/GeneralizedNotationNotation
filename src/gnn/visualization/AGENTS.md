...
### Graph Visualization
```python
from gnn.visualization import generate_graph_visualization
...
```python
from gnn.visualization import generate_matrix_visualization
...
- `tests/visualization/test_visualization_sampling.py` - Downsampling (pure) tests
- `tests/visualization/test_visualization_matrix_collect.py` - Matrix collection tests
- `tests/visualization/test_visualization_stats.py` - Connection-statistics tests
- `tests/visualization/test_visualization_backends.py` - Backend-status + theme-SSOT regression tests
