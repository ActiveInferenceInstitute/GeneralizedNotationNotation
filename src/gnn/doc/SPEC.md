...
The `src/gnn/doc/` directory is an **internal documentation subtree** providing source-adjacent reference material supporting `src/` implementation and maintenance.
