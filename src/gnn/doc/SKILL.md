...
description: Source-adjacent GNN implementation documentation. Use when working with static reference notes under `src/gnn/doc/` or checking that implementation-near documentation is intentionally non-runtime.
---
