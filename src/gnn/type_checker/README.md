...
python src/gnn/5_type_checker.py --target-dir input/gnn_files --output-dir output/5_type_checker_output
...
python src/gnn/5_type_checker.py --estimate-resources
```
