...
```python
from gnn.advanced_visualization.dashboard import DashboardGenerator
...
```python
from gnn.advanced_visualization.html_generator import HTMLVisualizationGenerator
...
```python
from gnn.advanced_visualization.visualizer import AdvancedVisualizer
...
Tests live in `tests/advanced_visualization/` (`test_advanced_visualization_overall.py`, `test_advanced_visualization_shared.py`, `test_advanced_visualization_statistical.py`, `test_advanced_visualization_interactive.py`, `test_advanced_visualization_html_generator.py`, `test_advanced_visualization_public_api.py`).
