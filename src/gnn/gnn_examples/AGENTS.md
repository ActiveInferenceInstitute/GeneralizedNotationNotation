...
2. **Use for testing** — reference model for round-trip tests configured in [`../testing/round_trip_config.py`](../testing/round_trip_config.py) (pytest cases in `tests/testing/test_round_trip.py`); scope vs all **23** `GNNFormat` values is defined in [`../SPEC.md`](../SPEC.md)
