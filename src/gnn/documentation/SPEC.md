...
Documentation accuracy is verified indirectly through the parser tests in `tests/gnn/test_gnn_parsing.py`, which parse content using the section names defined here.
