...
- [`doc/gnn/language/gnn_syntax_quickref.md`](../../../doc/gnn/language/gnn_syntax_quickref.md) is the **v2 quick reference** with examples; it complements but does not replace the normative doc.
