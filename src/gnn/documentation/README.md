...
- [`docs/gnn/reference/gnn_syntax.md`](../../../docs/gnn/reference/gnn_syntax.md) is the **v1.1 normative** syntax specification for parsers and validators.
- [`docs/gnn/language/gnn_syntax_quickref.md`](../../../docs/gnn/language/gnn_syntax_quickref.md) is the **v2 quick reference** with examples; it complements but does not replace the normative doc.
- File structure (doc tree): [`docs/gnn/reference/gnn_file_structure_doc.md`](../../../docs/gnn/reference/gnn_file_structure_doc.md)
