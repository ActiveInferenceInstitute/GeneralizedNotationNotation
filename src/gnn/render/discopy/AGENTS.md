...
**Parent Module**: `src/gnn/render/` (Step 11: Code rendering)
...
Module path: `src/gnn/render/discopy/`
...
**Location**: `src/gnn/render/discopy/discopy_renderer.py` (module-level function).
