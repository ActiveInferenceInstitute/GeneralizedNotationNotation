...
`src/gnn/render/numpyro/` renders a parsed GNN/POMDP model into a **standalone NumPyro** simulation script.

## Usage

```python
from pathlib import Path
from gnn.render.numpyro import render_gnn_to_numpyro
