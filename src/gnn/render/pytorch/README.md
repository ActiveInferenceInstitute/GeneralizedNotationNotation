...
`src/gnn/render/pytorch/` renders a parsed GNN/POMDP model into a **standalone PyTorch** simulation script.

## Usage

```python
from pathlib import Path
from gnn.render.pytorch import render_gnn_to_pytorch
