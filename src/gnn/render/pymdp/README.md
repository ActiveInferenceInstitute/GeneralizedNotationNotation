...
Exported from `src/gnn/render/pymdp/__init__.py`:
...
- Called by the Step 11 render pipeline (`src/gnn/render/processor.py`).
...
Relevant tests live in `tests/`, including render+execute integration and
