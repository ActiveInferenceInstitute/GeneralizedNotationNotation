...
```python
from gnn.model_registry import ModelRegistry
...
Tests live in `tests/model_registry/` (`test_model_registry_overall.py`, `test_model_registry_roundtrip.py`, `test_model_registry_public_api.py`).
