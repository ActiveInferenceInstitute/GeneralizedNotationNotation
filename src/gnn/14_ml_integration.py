...
Architectural Role:
    ...
    to the corresponding module (src/gnn/ml_integration/). It handles argument parsing, logging
...
How to run:
  uv run python src/gnn/14_ml_integration.py --target-dir input/gnn_files --output-dir output --verbose
...
If you encounter errors:
  ...
  - Check that src/gnn/ml_integration/ contains ml_integration modules
