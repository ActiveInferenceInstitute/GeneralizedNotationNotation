...
def mermaid_to_gnn(
    mermaid_content: str, validate_ontology: bool = False
) -> Dict[str, Any]:
    """
...
def _merge_variables(
    metadata_vars: Dict[str, Any], visual_nodes: Dict[str, Dict[str, Any]]
) -> Dict[str, Any]:
    """
    ...
    for node_id, node_data in visual_nodes.items():
        if node_id not in merged:
            ...
            merged[node_id] = {
                ...
                "description": node_data["label_parts"][0]
...
def _merge_connections(
    metadata_conns: List[Dict[str, Any]], visual_edges: List[Dict[str, Any]]
) -> List[Dict[str, Any]]:
    """
        ...
        merged.append(
            {
                ...
                or (metadata_conn.get("description", "") if metadata_conn else ""),
            }
        )
...
def _reconstruct_ontology_mappings(
    variables: Dict[str, Any], ontology_map: Dict[str, str]
) -> List[Dict[str, str]]:
    """
