...
python src/gnn/22_gui.py --gui-types oxdraw --target-dir input/gnn_files --output-dir output --headless --verbose
```
...
python3 src/gnn/main.py --only-steps "3,22" --verbose
```
...
```
src/gnn/gui/oxdraw/                 # Module implementation
