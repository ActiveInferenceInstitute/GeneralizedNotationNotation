...
- `tests/visualization/test_mermaid_converter.py` - Converter unit tests
- `tests/visualization/test_mermaid_parser.py` - Parser unit tests
...
- Check ontology terms in `src/gnn/ontology/act_inf_ontology_terms.json`
