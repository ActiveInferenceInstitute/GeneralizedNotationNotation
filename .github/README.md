...
- **Notation**: Models are written as **Markdown** with labeled sections (for example `## GNNSection`, `## StateSpaceBlock`, `## Connections`, `## InitialParameterization`, ontology annotations). The normative and reference material is split across [doc/gnn/reference/gnn_syntax.md](../doc/gnn/reference/gnn_syntax.md) (v1.5.0 living spec), [doc/gnn/reference/gnn_syntax.md](../doc/gnn/reference/gnn_syntax.md) (examples and patterns), and the [language hub](../doc/gnn/language/README.md).
