...
- `tests/ontology/test_ontology_annotations.py`
  - Added case, list-marker, comment, and section-boundary parsing coverage.
- `tests/ontology/test_ontology_public_api.py`
...
- `tests/research/test_research_functional.py`
