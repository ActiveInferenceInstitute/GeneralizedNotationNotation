...
- `src/gnn/type_checker/checking/core.py`
...
- `src/gnn/type_checker/checking/dimensions.py`
...
- `src/gnn/type_checker/checking/rules.py`
...
- `tests/type_checker/test_resource_estimation_contract.py` (new)
...
- `tests/type_checker/test_type_checker_discovery.py`
  - Added regression coverage excluding `README.md` and `AGENTS.md` from model discovery.
- `tests/validation/test_consistency_contract.py` (new)
