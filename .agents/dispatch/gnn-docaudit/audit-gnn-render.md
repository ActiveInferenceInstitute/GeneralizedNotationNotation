...
- doc/gnn/ (GNN language docs + gnn_syntax + integration guides)
- doc/rxinfer/, doc/activeinference_jl/, doc/pymdp/, doc/execution/FRAMEWORK_*
- doc/discopy/, doc/bnlearn/, doc/d2/, doc/pomdp/, doc/templates/
Audit every documented GNN grammar rule, renderer/framework script reference
(src/gnn/render/...), exemplar path (input/gnn_files/...), and generated-Julia/CLI
invocation against the current tree.
