# core — GNN documentation-vs-code audit (REPORT-ONLY)
...
- Root-level docs: README.md, AGENTS.md, ARCHITECTURE.md, DOCS.md, SETUP_GUIDE.md,
  SPEC.md, SKILL.md, CONTRIBUTING.md, CLAUDE.md
- doc/pipeline/, doc/execution/, doc/deployment/, doc/configuration/,
  doc/development/ (incl. PIPELINE_SCRIPTS.md)
Audit every documented command (pipeline steps, `uv run`, `just` recipes), script
path, numbered-step reference (N_*.py), and public API mention against the current
tree.

## Report
Write a concise evidence-first report to:
/home/trim/Documents/Git/HumOS/projects/outside_of_hum/GeneralizedNotationNotation/.agents/dispatch/gnn-docaudit/REPORT-core.md
