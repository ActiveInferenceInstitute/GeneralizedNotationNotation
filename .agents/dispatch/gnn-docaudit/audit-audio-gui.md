...
Audit documented audio/sonification functions (src/gnn/audio/, src/gnn/audio/sapf/),
DSP parameters, GUI/oxdraw interfaces, and any src/gnn/gui references against the
current tree.

## Report
Write a concise evidence-first report to:
<repo-root>/.agents/dispatch/gnn-docaudit/REPORT-audio-gui.md
