...
def test_predict_batch_garbage_artifact_raises(tmp_path: Path) -> None:
    from gnn.ml_integration import InferenceError, predict_batch
...
def test_load_classifier_missing_dependency_raises_inference_error(
    ...
    import gnn.ml_integration.inference as inference_mod
    from gnn.ml_integration import InferenceError
