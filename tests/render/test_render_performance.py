...
class TestRenderingSpeed:
    ...
    def test_framework_render_speed(self, tmp_path: Any) -> Any:
        ...
        from gnn.render import get_supported_frameworks
...
class TestRendererPerformance:
    ...
    def test_renderer_instantiation_speed(self) -> Any:
        ...
        from gnn.render import PyMDPRenderer
    ...
    def test_template_loading_speed(self) -> Any:
        ...
        from gnn.render import get_module_info
...
class TestCodeGenerationPerformance:
    ...
    def test_multi_framework_generation_speed(
        ...
        from gnn.render import PyMDPRenderer, get_supported_frameworks
