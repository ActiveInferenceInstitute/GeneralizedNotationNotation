...
def test_discopy_improvements() -> Any:
    ...
    try:
        from gnn.render.discopy.translator import (
...
"""
    ...
    try:
        ...
        from gnn.render.discopy.translator import gnn_file_to_discopy_matrix_diagram
    ...
    from gnn.render.discopy.translator import Box, Dim, jax
