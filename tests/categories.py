...
MODULAR_TEST_CATEGORIES: Dict[str, TestCategory] = {
    ...
    "environment": {
        ...
        "files": [
            "infrastructure/test_environment_dependencies.py",
            "infrastructure/test_environment_integration.py",
            "infrastructure/test_environment_overall.py",
            "infrastructure/test_environment_python.py",
            "infrastructure/test_environment_system.py",
        ],
        "markers": [],
        "timeout_seconds": 90,
        "max_failures": 6,
    ...
    "comprehensive": {
        ...
        "files": [
            ...
            "infrastructure/test_coverage_assessment.py",
            "infrastructure/test_coverage_overall.py",
            "test_fast_suite.py",
