...
from gnn.integration.meta_analysis.collector import SweepDataCollector, SweepRecord
from gnn.integration.meta_analysis.statistics import compute_meta_statistics
from gnn.integration.meta_analysis.validator import validate_sweep_records
...
def test_visualizer_treats_non_sweep_records_as_info(
    ...
    import gnn.integration.meta_analysis.visualizer as visualizer
