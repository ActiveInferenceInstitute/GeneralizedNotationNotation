...
def test_calculate_pipeline_health_score_perfect_run_is_high() -> Any:
    from gnn.intelligent_analysis.analyzer import calculate_pipeline_health_score
...
def test_classify_failure_severity_returns_recognized_level() -> Any:
    from gnn.intelligent_analysis.analyzer import classify_failure_severity
...
def test_detect_performance_patterns_returns_list() -> Any:
    from gnn.intelligent_analysis.analyzer import detect_performance_patterns
...
def test_generate_optimization_suggestions_returns_list() -> Any:
    from gnn.intelligent_analysis.analyzer import generate_optimization_suggestions
...
def test_suggest_fix_accepts_violation_object() -> Any:
    ...
    from gnn.intelligent_analysis.remediation import suggest_fix
