...
class TestCoverageImprovementPriorities:
    ...
    def test_priority_1_critical_apis(self) -> Any:
        ...
        critical_apis: list[Any] = [
            ...
            "gnn.render.render_gnn_to_pymdp",
            "gnn.render.render_gnn_to_rxinfer",
            "gnn.export.export_gnn_model",
            "gnn.export.import_gnn_model",
            "gnn.type_checker.validate_types",
            "gnn.validation.validate_model_consistency",
        ]
