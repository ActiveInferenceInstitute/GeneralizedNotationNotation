...
- ``_shared._conn_endpoints`` connection normalization (scalar and
  multi-variable connection formats).
...
class TestConnEndpoints:
    def _fn(self) -> Any:
        from gnn.advanced_visualization._shared import _conn_endpoints
