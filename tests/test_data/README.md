...
The sample model is the same ActInf POMDP used by `docs/gnn/tutorials/gnn_examples_doc.md`
and the walkthroughs in `docs/gnn/tutorials/`, so it is a stable reference point for
