"""Provides helper functions: test_template_index_contains_documented_pull_target, test_template_index_is_externalized_and_has_three_entries, test_packaged_templates_pass_strict_cli_validation, test_template_index_rejects_paths_outside_package_contract, and 11 more.

Public functions: test_template_index_contains_documented_pull_target, test_template_index_is_externalized_and_has_three_entries, test_packaged_templates_pass_strict_cli_validation, test_template_index_rejects_paths_outside_package_contract, test_show_template_returns_gridworld_record, test_pull_template_dry_run_does_not_copy, test_pull_template_copies_with_checksum, test_pull_template_rejects_checksum_collision_without_overwrite, test_pull_template_overwrite_replaces_checksum_collision, test_pull_template_rejects_symlink_destination, test_templates_list_cli_outputs_json, test_pull_cli_dry_run_outputs_json, test_templates_show_cli_outputs_one_template, test_pull_cli_unknown_template_fails, test_template_cli_works_from_installed_wheel_outside_repo
"""
