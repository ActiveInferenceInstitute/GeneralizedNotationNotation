...
class TestPipelineDiscovery:
    ...
    def test_discovery_imports(self) -> None:
        ...
        from gnn.pipeline import discovery
...
class TestVerifyPipeline:
    ...
    def test_verify_imports(self) -> None:
        ...
        from gnn.pipeline import verify_pipeline
    ...
    def test_verify_module_imports(self) -> None:
        ...
        from gnn.pipeline.verify_pipeline import verify_module_imports
    ...
    def test_verify_step_files(self) -> None:
        ...
        from gnn.pipeline.verify_pipeline import verify_step_files
