...
REAL_CONFIG = Path(__file__).parent.parent.parent / "input" / "config.yaml"
...
class TestPlanIsClean:
    def test_real_config_plan_reviews_empty(self) -> Any:
        ...
        from gnn.pipeline.pipeline_container_plan import (
            plan_for_pipeline,
    ...
    def test_hardened_defaults_present(self, tmp_path: Path) -> Any:
        from gnn.pipeline.pipeline_container_plan import plan_for_pipeline
