"""Provides helper functions: test_autonomous_loop_writes_proposals_without_source_mutation, test_autonomous_observation_streams_include_array_and_manifest_files, test_autonomous_scoring_uses_existing_execution_summary, test_autonomous_evidence_collects_release_ledgers.

Public functions: test_autonomous_loop_writes_proposals_without_source_mutation, test_autonomous_observation_streams_include_array_and_manifest_files, test_autonomous_scoring_uses_existing_execution_summary, test_autonomous_evidence_collects_release_ledgers
"""
...
from gnn.pipeline.autonomous import (
