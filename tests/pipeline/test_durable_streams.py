...
from gnn.pipeline.durable_streams import (  # noqa: E402
    ExecutionTrace,
    StreamKind,
    StreamManifest,
...
class TestTraceIntegrityNegativeControls:
    def test_seq_gap_detected(self) -> Any:
        from gnn.pipeline.durable_streams import TraceEvent
...
def test_replay_no_field_framing_collision() -> None:
    ...
    from gnn.pipeline.durable_streams import ExecutionTrace, TraceEvent, replay_trace
...
def test_array_checksum_is_byte_order_canonical() -> None:
    ...
    from gnn.pipeline.durable_streams import StreamManifest
