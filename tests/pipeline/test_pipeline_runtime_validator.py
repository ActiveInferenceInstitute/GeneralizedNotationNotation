...
def test_probe_targets_exist_in_canonical_layout() -> None:
    ...
    assert (root / "utils/pipeline_orchestration/pipeline_dependencies.py").is_file()
...
def test_code_generation_fix_probes_validate_clean_tree(
    ...
    (tmp_path / "utils/pipeline_orchestration").mkdir(parents=True)
    (tmp_path / "utils/pipeline_orchestration/pipeline_dependencies.py").write_text("")
