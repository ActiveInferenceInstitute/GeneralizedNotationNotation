...
from gnn.llm.providers.base_provider import BaseLLMProvider, LLMConfig  # noqa: E402
...
class TestProviderConcreteBehavior:
    ...
    def test_openrouter_provider_instantiation(self) -> None:
        ...
        from gnn.llm.providers.openrouter_provider import OpenRouterProvider
    ...
    def test_perplexity_provider_instantiation(self) -> None:
        ...
        from gnn.llm.providers.perplexity_provider import PerplexityProvider
