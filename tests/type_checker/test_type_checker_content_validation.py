...
from gnn.type_checker import GNNTypeChecker, summarize_type_check_results
...
def test_validate_gnn_files_estimate_resources_writes_reports(
    ...
    monkeypatch.setattr(
        "gnn.type_checker.visualizer.generate_all_visualizations",
        lambda *_a, **_kw: [],
    )
...
def test_validate_single_gnn_file_never_raises_on_content_error(
    ...
    monkeypatch.setattr("gnn.type_checker.checking.core.estimate_file_resources", _boom)
