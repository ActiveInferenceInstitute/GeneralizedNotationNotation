...
class TestVarTypeColor:
    ...
    def _fn(self) -> Any:
        from gnn.visualization.theme import get_var_type_color

        return get_var_type_color

    def test_known_type_returns_2d_palette_color(self) -> None:
        from gnn.visualization.theme import VAR_TYPE_COLORS
...
class TestEdgeStyle:
    ...
    def _fn(self) -> Any:
        from gnn.visualization.theme import get_edge_style

        return get_edge_style

    def test_known_connection_type(self) -> None:
        from gnn.visualization.theme import EDGE_STYLES
...
class TestThemeConstants:
    ...
    def test_palettes_are_populated(self) -> None:
        from gnn.visualization.theme import (
    ...
    def test_figure_defaults(self) -> None:
        from gnn.visualization.theme import FIGURE_DEFAULTS
    ...
    def test_colormap_presets(self) -> None:
        from gnn.visualization.theme import COLORMAP_PRESETS
    ...
    def test_max_figure_dimension_guard(self) -> None:
        from gnn.visualization.theme import MAX_FIGURE_DIMENSION
