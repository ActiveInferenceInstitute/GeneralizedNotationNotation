"""Provides helper functions: test_audio_telemetry_frames_from_execution_trace, test_audio_stream_chunks_are_device_free, test_audio_stream_summary_empty_chunks_is_not_success_like, test_audio_frames_accept_step12_simulation_data_aliases, and 7 more.

Public functions: test_audio_telemetry_frames_from_execution_trace, test_audio_stream_chunks_are_device_free, test_audio_stream_summary_empty_chunks_is_not_success_like, test_audio_frames_accept_step12_simulation_data_aliases, test_audio_frames_accept_vector_free_energy_and_action_samples, test_audio_streaming_loads_execution_output_dir, test_audio_streaming_follows_step12_summary_structured_result, test_audio_summary_artifact_resolver_handles_execution_rooted_relative_paths, test_audio_streaming_rejects_summary_pointer_outside_execution_dir, test_audio_streaming_discovers_sibling_step12_output, test_audio_streaming_empty_telemetry_reports_no_frames
"""
...
from gnn.audio.processor import (
    _process_audio_streaming,
    _resolve_execution_summary_artifact,
)
from gnn.audio.streaming import (
    chunks_from_frames,
