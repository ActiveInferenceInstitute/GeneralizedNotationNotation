...
def test_export_mcp_list_formats() -> None:
    from gnn.export.mcp import list_export_formats_mcp
...
def test_export_mcp_validate_format() -> None:
    from gnn.export.mcp import validate_export_format_mcp
...
def test_export_mcp_process_directory(tmp_path: Path) -> None:
    from gnn.export.mcp import process_export_mcp
...
def test_export_mcp_register_tools() -> None:
    from gnn.export.mcp import register_tools
...
def test_model_registry_mcp_register_and_list(tmp_path: Path) -> None:
    from gnn.model_registry.mcp import list_models, register_model
...
def test_model_registry_mcp_get_and_search(tmp_path: Path) -> None:
    from gnn.model_registry.mcp import get_model, search_models
...
def test_model_registry_mcp_register_tools() -> None:
    from gnn.model_registry.mcp import register_tools
...
def test_cli_mcp_health_and_preflight() -> None:
    from gnn.cli.mcp import cli_health_check, cli_preflight
