...
from gnn.export.core import export_gnn_files  # noqa: E402
from gnn.export.format_exporters import (  # noqa: E402
    export_to_gexf,
    export_to_graphml,
...
def test_graph_exports_fail_closed_without_networkx(
    ...
    import gnn.export.format_exporters as fe
...
def test_export_gnn_files_writes_all_formats(tmp_path: Path) -> None:
    ...
    from gnn.export.core import HAS_NETWORKX
...
def test_export_gnn_files_fails_closed_without_exporters(
    ...
    import gnn.export.core as core_mod
