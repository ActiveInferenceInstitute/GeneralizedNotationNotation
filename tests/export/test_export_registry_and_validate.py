...
class TestRegistry:
    ...
    def test_registry_has_eight_formats(self) -> None:
        from gnn.export.registry import get_export_registry
    ...
    def test_resolve_writer_known(self) -> None:
        ...
        from gnn.export.registry import resolve_format_writer
    ...
    def test_categories(self) -> None:
        from gnn.export.registry import get_format_categories
    ...
    def test_is_supported(self) -> None:
        from gnn.export.registry import is_supported_format
    ...
    def test_format_spec_lookup(self) -> None:
        from gnn.export.registry import get_format_spec
...
class TestValidateExportOutputs:
    ...
    def test_valid_manifest(self, _manifest_dir: Path) -> None:
        from gnn.export.processor import validate_export_outputs
        ...
        assert result["invalid"] == [
            {
                "file": str(exported),
                "format": "xml",
                "error": "DTDForbidden(name='gnn_model', system_id=None, public_id=None)",
            }
        ]
...
class TestCoreFailurePropagation:
    ...
    def test_format_exporters_failure_propagates(
        ...
        from gnn.export import core as core_mod
        from gnn.export import format_exporters as fe
        from gnn.export.core import export_gnn_files
