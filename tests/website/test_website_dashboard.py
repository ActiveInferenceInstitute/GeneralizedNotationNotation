...
class TestLoadJson:
    def test_missing_file_returns_empty_dict(self, tmp_path: Any) -> None:
        from gnn.website.dashboard import _load_json
...
class TestStatusColor:
    def _fn(self) -> Any:
        from gnn.website.dashboard import _status_color
...
class TestDiscoverStepDirs:
    def test_only_digit_output_dirs(self, tmp_path: Any) -> None:
        from gnn.website.dashboard import _discover_step_dirs
...
class TestRenderHelpers:
    def test_render_sidebar_with_steps(self) -> None:
        from gnn.website.dashboard import _render_sidebar
    ...
    def test_render_timeline_svg_no_steps(self) -> None:
        from gnn.website.dashboard import _render_timeline_svg
    ...
    def test_render_stats_with_step_dirs(self, tmp_path: Any) -> None:
        from gnn.website.dashboard import _render_stats
...
class TestRenderDashboard:
    def test_renders_dashboard_to_output(self, tmp_path: Any) -> None:
        from gnn.website.dashboard import render_dashboard
