...
from gnn.gui import generate_html_navigation, process_gui
...
class TestGUI3DesignStudioActions:
    ...
    def test_state_space_buttons_mutate_list_rows(self) -> None:
        from gnn.gui.gui_3.ui_designer import (
    ...
    def test_add_mapping_updates_existing_variable(self) -> None:
        from gnn.gui.gui_3.ui_designer import _add_ontology_mapping
    ...
    def test_list_backed_tables_export_complete_gnn(self) -> None:
        from gnn.gui.gui_3.ui_designer import _generate_gnn_from_design
    ...
    def test_loaded_model_parameters_seed_default_controls(self) -> None:
        from gnn.gui.gui_3.ui_designer import _parse_gnn_for_design
    ...
    def test_every_design_studio_action_button_is_bound(self) -> None:
        ...
        from gnn.gui.gui_3.ui_designer import build_design_studio
