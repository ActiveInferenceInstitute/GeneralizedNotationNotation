...
μToA_μ :: μ -> A_μ
μToA_μ x = undefined  -- TODO: implement connection
A_μToo :: A_μ -> o
A_μToo x = undefined  -- TODO: implement connection
A_ΣToε_o :: A_Σ -> ε_o
A_ΣToε_o x = undefined  -- TODO: implement connection
oToε_o :: o -> ε_o
oToε_o x = undefined  -- TODO: implement connection
ε_oToF :: ε_o -> F
ε_oToF x = undefined  -- TODO: implement connection
Π_oToF :: Π_o -> F
Π_oToF x = undefined  -- TODO: implement connection
μToB_f :: μ -> B_f
μToB_f x = undefined  -- TODO: implement connection
B_fToμ_prime :: B_f -> μ_prime
B_fToμ_prime x = undefined  -- TODO: implement connection
B_uToμ_prime :: B_u -> μ_prime
B_uToμ_prime x = undefined  -- TODO: implement connection
uToB_u :: u -> B_u
uToB_u x = undefined  -- TODO: implement connection
ε_xToF :: ε_x -> F
ε_xToF x = undefined  -- TODO: implement connection
Π_xToF :: Π_x -> F
Π_xToF x = undefined  -- TODO: implement connection
C_μToG :: C_μ -> G
C_μToG x = undefined  -- TODO: implement connection
C_ΣToG :: C_Σ -> G
C_ΣToG x = undefined  -- TODO: implement connection
μ_primeToG :: μ_prime -> G
μ_primeToG x = undefined  -- TODO: implement connection
GTou :: G -> u
GTou x = undefined  -- TODO: implement connection
μToΣ :: μ -> Σ
μToΣ x = undefined  -- TODO: implement connection
ΣToΠ_o :: Σ -> Π_o
ΣToΠ_o x = undefined  -- TODO: implement connection
