...
D_posTos_pos x = undefined  -- TODO: implement connection
D_velTos_vel :: D_vel -> s_vel
D_velTos_vel x = undefined  -- TODO: implement connection
s_posToA_vis :: s_pos -> A_vis
s_posToA_vis x = undefined  -- TODO: implement connection
A_visToo_vis :: A_vis -> o_vis
A_visToo_vis x = undefined  -- TODO: implement connection
s_velToA_prop :: s_vel -> A_prop
s_velToA_prop x = undefined  -- TODO: implement connection
A_propToo_prop :: A_prop -> o_prop
A_propToo_prop x = undefined  -- TODO: implement connection
s_posToB_pos :: s_pos -> B_pos
s_posToB_pos x = undefined  -- TODO: implement connection
s_velToB_vel :: s_vel -> B_vel
s_velToB_vel x = undefined  -- TODO: implement connection
B_posTos_pos :: B_pos -> s_pos
B_posTos_pos x = undefined  -- TODO: implement connection
B_velTos_vel :: B_vel -> s_vel
B_velTos_vel x = undefined  -- TODO: implement connection
s_posTom_pos_to_vis :: s_pos -> m_pos_to_vis
s_posTom_pos_to_vis x = undefined  -- TODO: implement connection
m_pos_to_visToA_vis :: m_pos_to_vis -> A_vis
m_pos_to_visToA_vis x = undefined  -- TODO: implement connection
o_visTom_vis_to_pos :: o_vis -> m_vis_to_pos
o_visTom_vis_to_pos x = undefined  -- TODO: implement connection
m_vis_to_posTos_pos :: m_vis_to_pos -> s_pos
m_vis_to_posTos_pos x = undefined  -- TODO: implement connection
s_velTom_vel_to_prop :: s_vel -> m_vel_to_prop
s_velTom_vel_to_prop x = undefined  -- TODO: implement connection
m_vel_to_propToA_prop :: m_vel_to_prop -> A_prop
m_vel_to_propToA_prop x = undefined  -- TODO: implement connection
o_propTom_prop_to_vel :: o_prop -> m_prop_to_vel
o_propTom_prop_to_vel x = undefined  -- TODO: implement connection
m_prop_to_velTos_vel :: m_prop_to_vel -> s_vel
m_prop_to_velTos_vel x = undefined  -- TODO: implement connection
C_visToG :: C_vis -> G
C_visToG x = undefined  -- TODO: implement connection
C_propToG :: C_prop -> G
C_propToG x = undefined  -- TODO: implement connection
GToπ :: G -> π
GToπ x = undefined  -- TODO: implement connection
πTou :: π -> u
πTou x = undefined  -- TODO: implement connection
B_posTou :: B_pos -> u
B_posTou x = undefined  -- TODO: implement connection
s_posToF :: s_pos -> F
s_posToF x = undefined  -- TODO: implement connection
s_velToF :: s_vel -> F
s_velToF x = undefined  -- TODO: implement connection
o_visToF :: o_vis -> F
o_visToF x = undefined  -- TODO: implement connection
o_propToF :: o_prop -> F
o_propToF x = undefined  -- TODO: implement connection
