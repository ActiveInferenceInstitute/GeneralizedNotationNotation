...
**Modules**: 38+ · **Pipeline steps**: 25 · **Renderers**: 10 backends wired under `src/gnn/render/` (8 with dedicated guides in this directory, plus `bnlearn` and `ngclearn`) · **Tests**: see [../../../README.md](../../../README.md)
