...
- **`src/gnn/5_type_checker.py`** → Type checking and resource estimation
  - Implementation: `src/gnn/type_checker/resource_estimator.py`
  - See: **[src/gnn/type_checker/AGENTS.md](../../../src/gnn/type_checker/AGENTS.md)** for detailed documentation
...
uv run python src/gnn/5_type_checker.py --target-dir input/gnn_files --estimate-resources --verbose
...
- **Step 16** (`src/gnn/16_analysis.py`) → Advanced statistical analysis of resource patterns
  - See: **[src/gnn/analysis/AGENTS.md](../../../src/gnn/analysis/AGENTS.md)**
- **Step 23** (`src/gnn/23_report.py`) → Comprehensive reporting including resource metrics
  - See: **[src/gnn/report/AGENTS.md](../../../src/gnn/report/AGENTS.md)**
...
*(For precise calculation formulas, refer to the implementation in `src/gnn/type_checker/resource_estimator.py`.)*
