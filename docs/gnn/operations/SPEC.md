...
| File | Purpose |
|------|---------|
| `gnn_tools.md` | Operator-facing tool index (subset of the live MCP registry — 145 tools across 34 modules per `src/gnn/mcp/audit_report.json` — plus pipeline scripts) |
