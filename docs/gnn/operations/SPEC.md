...
| File | Purpose |
|------|---------|
| `gnn_tools.md` | Operator-facing tool index (subset of the live MCP registry — 140 tools across 32 modules per `src/gnn/mcp/audit_report.json` — plus pipeline scripts) |
