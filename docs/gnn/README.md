...
**GNN documentation bundle**: v3.3.0 Engine (Bundle v2.0.0) (this tree and front matter on major pages)
**GNN syntax standard**: v1.1 (see [gnn_syntax.md](gnn_syntax.md))
**Python package** (`generalized-notation-notation`): **3.3.0** ([pyproject.toml](../../pyproject.toml))
