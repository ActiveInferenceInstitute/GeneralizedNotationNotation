...
- Relative links into `docs/gnn/`, `docs/active_inference/`, and framework docs where relevant.

## Non-goals

- Normative GNN syntax (see [docs/gnn/reference/gnn_syntax.md](../gnn/reference/gnn_syntax.md)).
