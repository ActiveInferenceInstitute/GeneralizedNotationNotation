...
- CLI options: `src/gnn/utils/arguments/arg_parsing.py` and `src/gnn/cli/__init__.py`
- Automatic YAML path: `input/config.yaml` and `src/gnn/utils/config_io/config_loader.py`
