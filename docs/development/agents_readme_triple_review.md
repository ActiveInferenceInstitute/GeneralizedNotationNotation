...
| 2 | Single source of truth | Pytest (documented ignores), grep across `README.md`, `CLAUDE.md`, [`../../AGENTS.md`](../../AGENTS.md), [`../../src/gnn/AGENTS.md`](../../src/gnn/AGENTS.md) |
...
| Pipeline smoke | `uv run python src/gnn/main.py --only-steps "3,5,11,12" --target-dir input/gnn_files --verbose` — 4/4 success; step 12 `SUCCESS_WITH_WARNINGS` (namespace conflict note only) |
